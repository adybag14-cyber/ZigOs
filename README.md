...
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5649988 metadata/file/block reads 112/4/114 failures 0 clusters claimed/free/loop/cross/range 11039/5072/0/0/0 lock tickets/outstanding 5/0 quarantine state/reason/events no/none/0 clean yes
...
ZigOs persistent VFS: ... backing alloc/release/fail 60/60/0/0 ... mapped refs/pin/unpin/refresh/fail 0/1/1/1/0 ... page-write tickets/outstanding 186/0 ... clean yes
...
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5598788 metadata/file/block reads 111/0/111 failures 0 clusters claimed/free/loop/cross/range 10939/5172/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes
ZigOs live pseudo filesystems: dev/proc/net registrations 3/5/4 publications 3/5/4 withdrawals 0/0/0 failures 0/0/0 clean yes
...
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5599300 metadata/file/block reads 112/3/113 failures 1 clusters claimed/free/loop/cross/range 10940/5171/0/0/0 lock tickets/outstanding 4/0 quarantine state/reason/events no/none/0 clean yes
ZigOs live pseudo filesystems: dev/proc/net registrations 3/5/4 publications 3/5/4 withdrawals 0/0/0 failures 0/0/0 clean yes
ZigOs normal userspace resources: processes 1 descriptors 0 contexts 0 pages 0 alloc/free 144/144 cache-released 13 storage persistent clean yes
...
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5599300 metadata/file/block reads 111/0/111 failures 0 clusters claimed/free/loop/cross/range 10940/5171/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes
ZigOs live pseudo filesystems: dev/proc/net registrations 3/5/4 publications 3/5/4 withdrawals 0/0/0 failures 0/0/0 clean yes
...
ZigOs live pseudo filesystems: dev/proc/net registrations 3/5/4 publications 3/5/4 withdrawals 0/0/0 failures 0/0/0 clean yes
ZigOs normal userspace resources: processes 1 descriptors 0 contexts 0 pages 0 alloc/free 66/66 cache-released 12 storage diskless-ram-root clean yes
...
- G258 keeps ABI 1.20 and completes shell exit-status propagation without adding new kernel interfaces. Every parsed command returns one `u32` shell status: foreground external commands propagate the exact `WaitStatus.exit_status`, successful builtins return 0, builtin/runtime failures return 1, usage errors return 2, and failed executable lookup returns 127. A dedicated `status` builtin reports the previous command value and then succeeds with 0. The required normal QEMU session proves `hello -> 42`, missing command `-> 127`, failed `cd -> 1`, and successful `pwd -> 0`, while PID 1 still reaps shell PID 2 with status 0. G259 consumes this status channel for `&&`/`||`; G260 now layers sequential semicolon lists over it, G267 now adds bounded shell-local `NAME=VALUE` assignment and child-environment/PATH override propagation; command substitution remains G268;
