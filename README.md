...
- a pointer-validated ABI 1.13 with generated kernel Zig, NASM, public Zig and C interfaces, capability discovery, bounded `spawnv`, System V-style argv/envp/auxv startup, all-writable-mount `sync`, root-gated empty-target `tmpfs` `mount`/`umount`, descriptor `lseek`/`fsync`/`fdatasync`/`fallocate`/`readv`/`writev`, path `stat`, `openat`, TTY `ioctl`, pathname mutation, sparse preallocation/hole punching, UDP datagram controls, exact waitpid, wait-any and WNOHANG;
...
- `/bin/c-sdk.elf` proving ABI 1.13 generated C layouts and wrappers, writable `/dev/null` and `/dev/zero`, an openable `/dev/console`, TTY ioctl flags, path `stat`, directory-descriptor and absolute `openat`, descriptor `fsync`/`fdatasync`, `symlink`, `readlink`, loop rejection, hard-link identity/stat link counts, sparse preallocation/hole punching and failure-atomic `readv`/`writev` before exiting with status `0x57`;
...
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5582916 metadata/file/block reads 49/4/51 failures 0 clusters claimed/loop/cross/range 10908/0/0/0 lock tickets/outstanding 5/0 quarantine state/reason/events no/none/0 clean yes
...
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5531204 metadata/file/block reads 49/0/49 failures 0 clusters claimed/loop/cross/range 10807/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes
ZigOs live pseudo filesystems: dev/proc/net registrations 3/5/4 publications 3/5/4 withdrawals 0/0/0 failures 0/0/0 clean yes
...
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5531716 metadata/file/block reads 50/3/51 failures 1 clusters claimed/loop/cross/range 10808/0/0/0 lock tickets/outstanding 4/0 quarantine state/reason/events no/none/0 clean yes
ZigOs live pseudo filesystems: dev/proc/net registrations 3/5/4 publications 3/5/4 withdrawals 0/0/0 failures 0/0/0 clean yes
ZigOs normal userspace resources: processes 1 descriptors 0 contexts 0 pages 0 alloc/free 132/132 cache-released 13 storage persistent clean yes
...
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5531716 metadata/file/block reads 49/0/49 failures 0 clusters claimed/loop/cross/range 10808/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes
ZigOs live pseudo filesystems: dev/proc/net registrations 3/5/4 publications 3/5/4 withdrawals 0/0/0 failures 0/0/0 clean yes
...
- **Portable Linux:** clean bootstrap, asset generation, formatting, 99 unique isolated declarations, directly linked Zig/C SDK, init, shell and DNS verification, x86-64 UEFI build, portable PE verification and artifact upload.
