...
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5576260 metadata/file/block reads 49/4/51 failures 0 clusters claimed/loop/cross/range 10895/0/0/0 lock tickets/outstanding 5/0 quarantine state/reason/events no/none/0 clean yes
...
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5525572 metadata/file/block reads 49/0/49 failures 0 clusters claimed/loop/cross/range 10796/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes
...
- **Portable Linux:** clean bootstrap, asset generation, formatting, 98 unique isolated declarations, directly linked Zig/C SDK, init, shell and DNS verification, x86-64 UEFI build, portable PE verification and artifact upload.
