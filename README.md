...
## Current release: Capstone 5.0

ZigOs Capstone 5.0 upgrades the legacy platform to boot-info ABI v2, a chunked EDD loader, dual in-memory kernel checksum verification, and a protected LBA256 FAT12 boundary. The kernel may now occupy up to 247 sectors instead of 55, leaving 98,816 bytes of verified growth space in the reference build. See [`docs/CAPSTONE-5.0.md`](docs/CAPSTONE-5.0.md) for the exact release contract.
