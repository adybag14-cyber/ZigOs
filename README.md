...
- `/bin/c-sdk.elf` proving ABI 1.19 generated C layouts and wrappers, writable `/dev/null` and `/dev/zero`, an openable `/dev/console`, TTY ioctl flags, path `stat`/`statfs`/`stattimes`/`statowner`, directory-descriptor and absolute `openat`, descriptor `fsync`/`fdatasync`, `symlink`, `readlink`, loop rejection, hard-link identity/stat link counts, sparse preallocation/hole punching and failure-atomic `readv`/`writev` before exiting with status `0x57`;
...
ZigOs persistent VFS: ... backing alloc/release/fail 54/54/0/0 ... mapped refs/pin/unpin/refresh/fail 0/1/1/1/0 ... page-write tickets/outstanding 186/0 ... clean yes
ZigOs persistent descriptors: ... dup/inherited/cloexec 4/56/1 ... clean yes
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5620292 metadata/file/block reads 111/4/113 failures 0 clusters claimed/free/loop/cross/range 10981/5130/0/0/0 lock tickets/outstanding 5/0 quarantine state/reason/events no/none/0 clean yes
...
ZigOs post-bootstrap physical memory: ... alloc/free 306/306 failed/rejected 0/0 clean yes
ZigOs permanent userspace: page-limit 4096 used 0 peak 48 contexts 0 file-mappings 0 launches/exits/faults 15/13/1 ... reclaimed 252 stale-contexts-swept 0 allocator alloc/release/retains 252/252/0 shared/oom/rejected 0/0/0 clean yes
...
ZigOs persistent VFS: ... backing alloc/release/fail 59/59/0/0 ... mapped refs/pin/unpin/refresh/fail 0/1/1/1/0 ... page-write tickets/outstanding 186/0 ... clean yes
ZigOs persistent descriptors: ... dup/inherited/cloexec 4/62/1 ... clean yes
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5620292 metadata/file/block reads 111/4/113 failures 0 clusters claimed/free/loop/cross/range 10981/5130/0/0/0 lock tickets/outstanding 5/0 quarantine state/reason/events no/none/0 clean yes
ZigOs live pseudo filesystems: dev/proc/net registrations 3/5/4 publications 3/5/4 withdrawals 0/0/0 failures 0/0/0 clean yes
ZigOs persistent storage: mounted yes generation/slot 1/0 ... NVMe read/write/flush .../2/2 errors 0/0 clean yes
ZigOs post-bootstrap physical memory: ... alloc/free 342/342 failed/rejected 0/0 clean yes
ZigOs permanent userspace: page-limit 4096 used 0 peak 48 contexts 0 file-mappings 0 launches/exits/faults 17/15/1 ... reclaimed 283 stale-contexts-swept 0 allocator alloc/release/retains 283/283/0 shared/oom/rejected 0/0/0 clean yes
...
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5569092 metadata/file/block reads 111/0/111 failures 0 clusters claimed/free/loop/cross/range 10881/5230/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes
ZigOs live pseudo filesystems: dev/proc/net registrations 3/5/4 publications 3/5/4 withdrawals 0/0/0 failures 0/0/0 clean yes
...
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5569604 metadata/file/block reads 112/3/113 failures 1 clusters claimed/free/loop/cross/range 10882/5229/0/0/0 lock tickets/outstanding 4/0 quarantine state/reason/events no/none/0 clean yes
ZigOs live pseudo filesystems: dev/proc/net registrations 3/5/4 publications 3/5/4 withdrawals 0/0/0 failures 0/0/0 clean yes
ZigOs normal userspace resources: processes 1 descriptors 0 contexts 0 pages 0 alloc/free 138/138 cache-released 13 storage persistent clean yes
...
ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5569604 metadata/file/block reads 111/0/111 failures 0 clusters claimed/free/loop/cross/range 10882/5229/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes
ZigOs live pseudo filesystems: dev/proc/net registrations 3/5/4 publications 3/5/4 withdrawals 0/0/0 failures 0/0/0 clean yes
