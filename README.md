...
## Current milestone: 3.8

The current checkpoint includes a native Intel 82574L/e1000e path with DMA descriptor recycling, transmit/receive ring wrap, interrupt-to-kernel completion queues, a persistent queue owner, a bounded software RX packet queue, and protocol-specific packet dispatch.
...
- The complete flow produces thirteen TX and twelve RX completion records, each dequeued once with zero overflow; software ingress and ICMP dispatch queues report balanced enqueue/dequeue totals and zero drops.
