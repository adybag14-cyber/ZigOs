...
- a 48-command offline permanent-runtime COM1 session;
- a 50-command live-network permanent-runtime COM1 session;
...
- file-backed mappings, pressure-driven cache reclaim and automatic writeback scheduling, page-granular writer locking, mmap/file cache coherence and broader asynchronous filesystem synchronization.
