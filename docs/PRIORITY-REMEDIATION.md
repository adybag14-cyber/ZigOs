...
Still open: general socket options, userspace resolver APIs, writable readiness/backpressure, richer routing/ARP lifecycle, TCP application data/HTTP and decomposition of the monolithic e1000e protocol source.
