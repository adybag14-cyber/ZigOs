...
- The COM1 QEMU driver drains all buffered stdout lines per iteration, polls at 1 ms, and treats 90 seconds as an inactivity limit refreshed by output and command progress rather than an absolute session wall-clock cap.
