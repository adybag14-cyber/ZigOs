...
- owner/group/other mode checks are enforced against UID plus one primary GID, but supplementary groups, credential-changing syscalls, `chown`, umask and setuid/setgid/sticky-directory semantics are not implemented;
