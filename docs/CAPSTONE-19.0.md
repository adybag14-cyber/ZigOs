...
- `/bin/wait.elf` spawns `/bin/sleep.elf` and `/bin/wait-short.elf`, overlapping a 32-tick child and one-tick child to prove completion-ordered wait-any, exact waitpid and WNOHANG before exiting `0x31`.
