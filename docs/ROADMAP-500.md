...
**Status after the persistent-storage, TTY, Zig/C-SDK, userspace-shell, startup-vector, persistent-executable, userspace-filesystem, userspace-init, ABI 1.11 platform/UDP/link/sparse-file/vectored-I/O/fsync/fdatasync, device-node and diskless-recovery advances:** 175 complete, 325 open.
