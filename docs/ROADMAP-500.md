...
- [x] **G197** ? Implement fsync for one file; stable committed regular-file paths use a transactional one-record A/B snapshot replacement, with unit failure injection and a forced-termination three-boot recovery proof.
