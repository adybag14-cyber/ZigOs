...
fn inspectE1000e(
    ...
    debugWrite("\r\n");
    debugWrite("NTP transport reopen verified: source ");
    debugWriteReferenceKind(network.ntp_transport_reopen.source_kind);
    debugWrite(", frequency/bits ");
    debugWriteU64Decimal(network.ntp_transport_reopen.frequency_hz);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.counter_bits);
    debugWrite(", sockets ");
    debugWriteU64Decimal(network.ntp_transport_reopen.old_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.old_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.old_local_port);
    debugWrite("->");
    debugWriteU64Decimal(network.ntp_transport_reopen.new_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.new_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.new_local_port);
    debugWrite(" server ");
    debugWriteIpv4(network.ntp_transport_reopen.server);
    debugWrite(", initial ");
    debugWriteU64Decimal(network.ntp_transport_reopen.initial_identification);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.initial_descriptor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.initial_next_cursor);
    debugWrite(" sample/time ");
    debugWriteU64Decimal(network.ntp_transport_reopen.initial_sample_tick);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.initial_seconds);
    debugWrite("/0x");
    debugWriteHex32(network.ntp_transport_reopen.initial_fraction);
    debugWrite(" synchronized ");
    debugWrite(if (network.ntp_transport_reopen.initial_synchronized) "yes" else "no");
    debugWrite(" loss discarded/queue ");
    debugWriteU64Decimal(network.ntp_transport_reopen.transport_discarded_packets);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.transport_queue_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.transport_queue_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.transport_queue_high_water);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.transport_queue_dropped);
    debugWrite(" abandon/endpoint ");
    debugWrite(if (network.ntp_transport_reopen.abandon_idle) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_transport_reopen.old_endpoint_gone) "yes" else "no");
    debugWrite(" reopen socket/peer/clock/source/cumulative/transient ");
    debugWrite(if (network.ntp_transport_reopen.reopen_socket_matches) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_transport_reopen.reopen_peer_matches) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_transport_reopen.clock_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_transport_reopen.source_policy_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_transport_reopen.cumulative_state_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_transport_reopen.transient_state_cleared) "yes" else "no");
    debugWrite(" duplicate rejected/preserved ");
    debugWrite(if (network.ntp_transport_reopen.duplicate_reopen_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_transport_reopen.duplicate_state_preserved) "yes" else "no");
    debugWrite(" refresh timestamp 0x");
    debugWriteHex64(network.ntp_transport_reopen.projected_refresh_timestamp);
    debugWrite(" TX ");
    debugWriteU64Decimal(network.ntp_transport_reopen.refresh_identification);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.refresh_descriptor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.refresh_next_cursor);
    debugWrite(" started/accepted ");
    debugWrite(if (network.ntp_transport_reopen.refresh_started) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_transport_reopen.refresh_accepted) "yes" else "no");
    debugWrite(" sample/time ");
    debugWriteU64Decimal(network.ntp_transport_reopen.refresh_sample_tick);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.refresh_seconds);
    debugWrite("/0x");
    debugWriteHex32(network.ntp_transport_reopen.refresh_fraction);
    debugWrite(" health sync/source/cumulative ");
    debugWrite(if (network.ntp_transport_reopen.health_synchronized) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_transport_reopen.health_source_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_transport_reopen.health_cumulative_preserved) "yes" else "no");
    debugWrite(" close ");
    debugWrite(if (network.ntp_transport_reopen.close_clean) "yes" else "no");
    debugWrite(" lifecycle ");
    debugWriteU64Decimal(network.ntp_transport_reopen.requests_started);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.retries);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.responses);
    debugWrite(" quality ");
    debugWriteU64Decimal(network.ntp_transport_reopen.quality_accepted);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.quality_rejected);
    debugWrite(" step ");
    debugWriteU64Decimal(network.ntp_transport_reopen.step_accepted);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.step_rejected);
    debugWrite(" final IP/TX ");
    debugWriteU64Decimal(network.ntp_transport_reopen.final_identification_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.final_tx_cursor);
    debugWrite(" submissions/completions ");
    debugWriteU64Decimal(network.ntp_transport_reopen.tx_submissions_delta);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.rx_completion_enqueues);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.ntp_transport_reopen.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.final_generation_cursor);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.ntp_transport_reopen.ingress_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.ingress_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_transport_reopen.udp_dispatched);
    debugWrite("\r\n");
    debugWrite("NTP active refresh reopen verified: source ");
    debugWriteReferenceKind(network.ntp_active_refresh_reopen.source_kind);
    debugWrite(", frequency/bits ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.frequency_hz);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.counter_bits);
    debugWrite(", sockets ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.old_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.old_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.old_local_port);
    debugWrite("->");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.new_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.new_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.new_local_port);
    debugWrite(" server ");
    debugWriteIpv4(network.ntp_active_refresh_reopen.server);
    debugWrite(", initial ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.initial_identification);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.initial_descriptor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.initial_next_cursor);
    debugWrite(" sample ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.initial_sample_tick);
    debugWrite(" synchronized ");
    debugWrite(if (network.ntp_active_refresh_reopen.initial_synchronized) "yes" else "no");
    debugWrite(" old refresh timestamp 0x");
    debugWriteHex64(network.ntp_active_refresh_reopen.old_refresh_timestamp);
    debugWrite(" TX ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.old_refresh_identification);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.old_refresh_descriptor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.old_refresh_next_cursor);
    debugWrite(" started/delayed ");
    debugWrite(if (network.ntp_active_refresh_reopen.old_refresh_started) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_active_refresh_reopen.old_delayed_queued) "yes" else "no");
    debugWrite(" loss discarded/queue ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.transport_discarded_packets);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.transport_queue_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.transport_queue_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.transport_queue_high_water);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.transport_queue_dropped);
    debugWrite(" abandon active/cancelled/timestamp/endpoint ");
    debugWrite(if (network.ntp_active_refresh_reopen.abandon_active) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_active_refresh_reopen.abandon_cancelled) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_active_refresh_reopen.abandon_timestamp_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_active_refresh_reopen.old_endpoint_gone) "yes" else "no");
    debugWrite(" reopen clock/source/cumulative/transient ");
    debugWrite(if (network.ntp_active_refresh_reopen.clock_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_active_refresh_reopen.source_state_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_active_refresh_reopen.cumulative_state_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_active_refresh_reopen.transient_state_cleared) "yes" else "no");
    debugWrite(" new timestamp 0x");
    debugWriteHex64(network.ntp_active_refresh_reopen.new_refresh_timestamp);
    debugWrite(" advanced ");
    debugWrite(if (network.ntp_active_refresh_reopen.timestamp_advanced) "yes" else "no");
    debugWrite(" TX ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.new_refresh_identification);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.new_refresh_descriptor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.new_refresh_next_cursor);
    debugWrite(" started ");
    debugWrite(if (network.ntp_active_refresh_reopen.new_refresh_started) "yes" else "no");
    debugWrite(" mixed queue/poll/examined/rejected ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.mixed_queue_pending);
    debugWrite("/");
    debugWriteNtpState(network.ntp_active_refresh_reopen.mixed_poll_state);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.mixed_examined);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.mixed_rejected);
    debugWrite(" old-rejected/new-accepted/no-retry ");
    debugWrite(if (network.ntp_active_refresh_reopen.old_originate_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_active_refresh_reopen.new_response_accepted) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_active_refresh_reopen.no_retry_or_extra_sample) "yes" else "no");
    debugWrite(" sample/time ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.sample_tick);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.accepted_seconds);
    debugWrite("/0x");
    debugWriteHex32(network.ntp_active_refresh_reopen.accepted_fraction);
    debugWrite(" health sync/source/cumulative ");
    debugWrite(if (network.ntp_active_refresh_reopen.health_synchronized) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_active_refresh_reopen.health_source_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_active_refresh_reopen.health_cumulative_preserved) "yes" else "no");
    debugWrite(" close ");
    debugWrite(if (network.ntp_active_refresh_reopen.close_clean) "yes" else "no");
    debugWrite(" lifecycle ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.requests_started);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.retries);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.responses);
    debugWrite(" quality ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.quality_accepted);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.quality_rejected);
    debugWrite(" step ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.step_accepted);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.step_rejected);
    debugWrite(" final IP/TX ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.final_identification_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.final_tx_cursor);
    debugWrite(" submissions/completions ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.tx_submissions_delta);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.rx_completion_enqueues);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.final_generation_cursor);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.ingress_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.ingress_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_active_refresh_reopen.udp_dispatched);
    debugWrite("\r\n");
    debugWrite("NTP reopen allocation failure verified: source ");
    debugWriteReferenceKind(network.ntp_reopen_allocation_failure.source_kind);
    debugWrite(", frequency/bits ");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.frequency_hz);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.counter_bits);
    debugWrite(", old socket ");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.old_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.old_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.old_local_port);
    debugWrite(" server ");
    debugWriteIpv4(network.ntp_reopen_allocation_failure.server);
    debugWrite(", loss discarded/queue ");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.transport_discarded_packets);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.transport_queue_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.transport_queue_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.transport_queue_high_water);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.transport_queue_dropped);
    debugWrite(" abandon ");
    debugWrite(if (network.ntp_reopen_allocation_failure.abandon_idle) "yes" else "no");
    debugWrite(" fillers ");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.filler_slots[0]);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.filler_generations[0]);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.filler_ports[0]);
    debugWrite("+");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.filler_slots[1]);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.filler_generations[1]);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.filler_ports[1]);
    debugWrite(" full ");
    debugWrite(if (network.ntp_reopen_allocation_failure.table_full) "yes" else "no");
    debugWrite(" failure cursors ");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.failure_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.failure_generation_cursor);
    debugWrite(" rejected/service/device ");
    debugWrite(if (network.ntp_reopen_allocation_failure.reopen_failed) "yes" else "no");
    debugWrite("/");
    ...
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.new_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.new_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.new_local_port);
    debugWrite(" succeeded/state/transient ");
    debugWrite(if (network.ntp_reopen_allocation_failure.reopen_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_allocation_failure.retained_state_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_allocation_failure.transient_state_cleared) "yes" else "no");
    debugWrite(" initial ");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.initial_identification);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.initial_descriptor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.initial_next_cursor);
    debugWrite(" started ");
    debugWrite(if (network.ntp_reopen_allocation_failure.initial_started) "yes" else "no");
    debugWrite(" sample/time ");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.sample_tick);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.accepted_seconds);
    debugWrite("/0x");
    debugWriteHex32(network.ntp_reopen_allocation_failure.accepted_fraction);
    debugWrite(" accepted ");
    debugWrite(if (network.ntp_reopen_allocation_failure.accepted) "yes" else "no");
    debugWrite(" health sync/cumulative ");
    debugWrite(if (network.ntp_reopen_allocation_failure.health_synchronized) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_allocation_failure.health_cumulative_preserved) "yes" else "no");
    debugWrite(" close ");
    debugWrite(if (network.ntp_reopen_allocation_failure.close_clean) "yes" else "no");
    debugWrite(" lifecycle ");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.requests_started);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.retries);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.responses);
    debugWrite(" quality ");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.quality_accepted);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.quality_rejected);
    debugWrite(" step ");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.step_accepted);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.step_rejected);
    debugWrite(" final IP/TX ");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.final_identification_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.final_tx_cursor);
    debugWrite(" submissions/completions ");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.tx_submissions_delta);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.rx_completion_enqueues);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.final_generation_cursor);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.ingress_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.ingress_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_allocation_failure.udp_dispatched);
    debugWrite("\r\n");
    debugWrite("NTP reopen validation failure verified: source ");
    debugWriteReferenceKind(network.ntp_reopen_validation_failure.source_kind);
    debugWrite(", frequency/bits ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.frequency_hz);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.counter_bits);
    debugWrite(", sockets ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.old_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.old_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.old_local_port);
    debugWrite("->");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.new_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.new_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.new_local_port);
    debugWrite(" server ");
    debugWriteIpv4(network.ntp_reopen_validation_failure.server);
    debugWrite(", initial ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.initial_identification);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.initial_descriptor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.initial_next_cursor);
    debugWrite(" sample ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.initial_sample_tick);
    debugWrite(" synchronized ");
    debugWrite(if (network.ntp_reopen_validation_failure.initial_synchronized) "yes" else "no");
    debugWrite(" loss discarded/queue ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.transport_discarded_packets);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.transport_queue_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.transport_queue_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.transport_queue_high_water);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.transport_queue_dropped);
    debugWrite(" abandon ");
    debugWrite(if (network.ntp_reopen_validation_failure.abandon_idle) "yes" else "no");
    debugWrite(" failures backward/server/retry/rotation ");
    debugWrite(if (network.ntp_reopen_validation_failure.backward_tick_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_validation_failure.server_mismatch_rejected) "yes" else "no");
    debugWrite("/");
    ...
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_validation_failure.device_cursors_preserved) "yes" else "no");
    debugWrite(" failure cursors ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.failure_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.failure_generation_cursor);
    debugWrite(" reopen succeeded/state/transient ");
    debugWrite(if (network.ntp_reopen_validation_failure.reopen_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_validation_failure.state_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_validation_failure.transient_state_cleared) "yes" else "no");
    debugWrite(" refresh timestamp 0x");
    debugWriteHex64(network.ntp_reopen_validation_failure.projected_refresh_timestamp);
    debugWrite(" TX ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.refresh_identification);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.refresh_descriptor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.refresh_next_cursor);
    debugWrite(" started ");
    debugWrite(if (network.ntp_reopen_validation_failure.refresh_started) "yes" else "no");
    debugWrite(" sample/time ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.sample_tick);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.accepted_seconds);
    debugWrite("/0x");
    debugWriteHex32(network.ntp_reopen_validation_failure.accepted_fraction);
    debugWrite(" accepted ");
    debugWrite(if (network.ntp_reopen_validation_failure.accepted) "yes" else "no");
    debugWrite(" health sync/source ");
    debugWrite(if (network.ntp_reopen_validation_failure.health_synchronized) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_validation_failure.health_source_preserved) "yes" else "no");
    debugWrite(" close ");
    debugWrite(if (network.ntp_reopen_validation_failure.close_clean) "yes" else "no");
    debugWrite(" lifecycle ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.requests_started);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.retries);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.responses);
    debugWrite(" quality ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.quality_accepted);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.quality_rejected);
    debugWrite(" step ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.step_accepted);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.step_rejected);
    debugWrite(" final IP/TX ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.final_identification_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.final_tx_cursor);
    debugWrite(" submissions/completions ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.tx_submissions_delta);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.rx_completion_enqueues);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.final_generation_cursor);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.ingress_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.ingress_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_validation_failure.udp_dispatched);
    debugWrite("\r\n");
    debugWrite("NTP reopen reason matrix verified: sockets ");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.old_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.old_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.old_local_port);
    debugWrite("->");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.new_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.new_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.new_local_port);
    debugWrite(" server ");
    debugWriteIpv4(network.ntp_reopen_reason_matrix.server);
    debugWrite(", live ");
    for (network.ntp_reopen_reason_matrix.live_reasons, 0..) |reason, index| {
        if (index != 0) debugWrite("/");
        debugWrite(@tagName(reason));
    }
    debugWrite(" policy ");
    for (network.ntp_reopen_reason_matrix.policy_reasons, 0..) |reason, index| {
        if (index != 0) debugWrite("/");
        debugWrite(@tagName(reason));
    }
    debugWrite(" source ");
    for (network.ntp_reopen_reason_matrix.source_reasons, 0..) |reason, index| {
        if (index != 0) debugWrite("/");
        debugWrite(@tagName(reason));
    }
    debugWrite(" exact/snapshots/cursors ");
    debugWrite(if (network.ntp_reopen_reason_matrix.all_reasons_exact) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_reason_matrix.snapshots_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_reason_matrix.device_cursors_preserved) "yes" else "no");
    debugWrite(" failure cursors ");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.failure_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.failure_generation_cursor);
    debugWrite(" inspect ready/target/state/device ");
    debugWrite(if (network.ntp_reopen_reason_matrix.inspection_ready) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_reason_matrix.inspection_target_matches) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_reason_matrix.inspection_state_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_reason_matrix.inspection_device_preserved) "yes" else "no");
    debugWrite(" stale-service ");
    debugWrite(@tagName(network.ntp_reopen_reason_matrix.stale_service_reason));
    debugWrite("/preserved ");
    debugWrite(if (network.ntp_reopen_reason_matrix.stale_service_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_reason_matrix.stale_service_device_preserved) "yes" else "no");
    debugWrite(" churn ");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.churn_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.churn_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.churn_socket_port);
    debugWrite("/closed ");
    debugWrite(if (network.ntp_reopen_reason_matrix.churn_closed) "yes" else "no");
    debugWrite(" stale-transport ");
    debugWrite(@tagName(network.ntp_reopen_reason_matrix.stale_transport_reason));
    debugWrite("/preserved ");
    debugWrite(if (network.ntp_reopen_reason_matrix.stale_transport_service_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_reason_matrix.stale_transport_device_preserved) "yes" else "no");
    debugWrite(" reinspect ready/match ");
    debugWrite(if (network.ntp_reopen_reason_matrix.reinspection_ready) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_reason_matrix.reinspection_matches) "yes" else "no");
    debugWrite(" execute/no-rejection/match ");
    debugWrite(if (network.ntp_reopen_reason_matrix.reopen_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_reason_matrix.success_has_no_rejection) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_reason_matrix.detailed_matches_inspection) "yes" else "no");
    debugWrite(" single-use ");
    debugWrite(@tagName(network.ntp_reopen_reason_matrix.single_use_reason));
    debugWrite("/preserved ");
    debugWrite(if (network.ntp_reopen_reason_matrix.single_use_state_preserved) "yes" else "no");
    debugWrite(" legacy rejected/preserved ");
    debugWrite(if (network.ntp_reopen_reason_matrix.legacy_active_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_reason_matrix.legacy_state_preserved) "yes" else "no");
    debugWrite(" close ");
    debugWrite(if (network.ntp_reopen_reason_matrix.close_clean) "yes" else "no");
    debugWrite(" final IP/TX ");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.final_identification_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.final_tx_cursor);
    debugWrite(" submissions unchanged ");
    debugWrite(if (network.ntp_reopen_reason_matrix.tx_submissions_unchanged) "yes" else "no");
    debugWrite(" completions ");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.rx_completion_enqueues);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.final_generation_cursor);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.ingress_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.ingress_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_reason_matrix.udp_dispatched);
    debugWrite("\r\n");
    debugWrite("NTP reopen plan integrity verified: sockets ");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.old_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.old_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.old_local_port);
    debugWrite("->");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.new_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.new_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.new_local_port);
    debugWrite(" server ");
    debugWriteIpv4(network.ntp_reopen_plan_integrity.server);
    debugWrite(" tag 0x");
    debugWriteHex64(network.ntp_reopen_plan_integrity.original_integrity_tag);
    debugWrite(" tampered tag/socket/server/source/clock/deadline/service/transport ");
    for (network.ntp_reopen_plan_integrity.tampered_reasons, 0..) |reason, index| {
        if (index != 0) debugWrite("/");
        debugWrite(@tagName(reason));
    }
    debugWrite(" rejected/snapshots ");
    debugWrite(if (network.ntp_reopen_plan_integrity.all_tampering_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_plan_integrity.service_snapshots_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_plan_integrity.device_snapshots_preserved) "yes" else "no");
    debugWrite(" execute/match ");
    debugWrite(if (network.ntp_reopen_plan_integrity.execution_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_plan_integrity.execution_matches_plan) "yes" else "no");
    debugWrite(" consumed ");
    debugWrite(@tagName(network.ntp_reopen_plan_integrity.consumed_plan_reason));
    debugWrite("/preserved ");
    debugWrite(if (network.ntp_reopen_plan_integrity.consumed_state_preserved) "yes" else "no");
    debugWrite(" close ");
    debugWrite(if (network.ntp_reopen_plan_integrity.close_clean) "yes" else "no");
    debugWrite(" final IP/TX ");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.final_identification_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.final_tx_cursor);
    debugWrite(" submissions unchanged ");
    debugWrite(if (network.ntp_reopen_plan_integrity.tx_submissions_unchanged) "yes" else "no");
    debugWrite(" completions ");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.rx_completion_enqueues);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.final_generation_cursor);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.ingress_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.ingress_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_integrity.udp_dispatched);
    debugWrite("\r\n");
    debugWrite("NTP reopen plan inspection verified: sockets ");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.old_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.old_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.old_local_port);
    debugWrite("->");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.new_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.new_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.new_local_port);
    debugWrite(" server ");
    debugWriteIpv4(network.ntp_reopen_plan_inspection.server);
    debugWrite(" original actual/expected/valid 0x");
    debugWriteHex64(network.ntp_reopen_plan_inspection.original_actual_tag);
    debugWrite("/0x");
    debugWriteHex64(network.ntp_reopen_plan_inspection.original_expected_tag);
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_plan_inspection.original_valid) "yes" else "no");
    debugWrite(" tampered tag/deadline/service/transport invalid ");
    for (network.ntp_reopen_plan_inspection.tampered_invalid, 0..) |invalid, index| {
        if (index != 0) debugWrite("/");
        debugWrite(if (invalid) "yes" else "no");
    }
    debugWrite(" different ");
    for (network.ntp_reopen_plan_inspection.tampered_tags_differ, 0..) |different, index| {
        if (index != 0) debugWrite("/");
        debugWrite(if (different) "yes" else "no");
    }
    debugWrite(" pure state/device ");
    debugWrite(if (network.ntp_reopen_plan_inspection.pure_service_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_plan_inspection.pure_device_preserved) "yes" else "no");
    debugWrite(" execute/match ");
    debugWrite(if (network.ntp_reopen_plan_inspection.execution_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_plan_inspection.execution_matches_plan) "yes" else "no");
    debugWrite(" consumed integrity/execution/reason/preserved ");
    debugWrite(if (network.ntp_reopen_plan_inspection.consumed_integrity_valid) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_plan_inspection.consumed_execution_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.ntp_reopen_plan_inspection.consumed_execution_reason));
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_plan_inspection.consumed_state_preserved) "yes" else "no");
    debugWrite(" close ");
    debugWrite(if (network.ntp_reopen_plan_inspection.close_clean) "yes" else "no");
    debugWrite(" final IP/TX ");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.final_identification_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.final_tx_cursor);
    debugWrite(" submissions unchanged ");
    debugWrite(if (network.ntp_reopen_plan_inspection.tx_submissions_unchanged) "yes" else "no");
    debugWrite(" completions ");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.rx_completion_enqueues);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.final_generation_cursor);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.ingress_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.ingress_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_plan_inspection.packets_dispatched);
    debugWrite("/");
    ...
    debugWrite("\r\n");
    debugWrite("NTP reopen execution preview verified: sockets ");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.old_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.old_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.old_local_port);
    debugWrite("->");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.new_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.new_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.new_local_port);
    debugWrite(" server ");
    debugWriteIpv4(network.ntp_reopen_execution_preview.server);
    debugWrite(" fillers ");
    for (network.ntp_reopen_execution_preview.filler_slots, 0..) |slot, index| {
        if (index != 0) debugWrite(",");
        debugWriteU64Decimal(slot);
        debugWrite("/");
        debugWriteU64Decimal(network.ntp_reopen_execution_preview.filler_generations[index]);
        debugWrite("/");
        debugWriteU64Decimal(network.ntp_reopen_execution_preview.filler_ports[index]);
    }
    debugWrite(" saturated freshness ");
    debugWrite(if (network.ntp_reopen_execution_preview.saturated_freshness_ready) "yes" else "no");
    for (network.ntp_reopen_execution_preview.saturated_freshness_flags) |flag| {
        debugWrite("/");
        debugWrite(if (flag) "yes" else "no");
    }
    debugWrite(" unavailable ");
    debugWrite(@tagName(network.ntp_reopen_execution_preview.unavailable_reason));
    debugWrite(" no-socket/preview-preserved/execution-rejected/execution-preserved ");
    debugWrite(if (network.ntp_reopen_execution_preview.unavailable_no_socket) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_preview.unavailable_preview_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_preview.unavailable_execution_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_preview.unavailable_execution_preserved) "yes" else "no");
    debugWrite(" fillers-closed ");
    debugWrite(if (network.ntp_reopen_execution_preview.fillers_closed) "yes" else "no");
    debugWrite(" released ");
    debugWrite(@tagName(network.ntp_reopen_execution_preview.released_reason));
    debugWrite(" no-socket/preserved ");
    debugWrite(if (network.ntp_reopen_execution_preview.released_no_socket) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_preview.released_preserved) "yes" else "no");
    debugWrite(" fresh flags/ready/available/predicted ");
    for (network.ntp_reopen_execution_preview.fresh_freshness_flags) |flag| {
        debugWrite(if (flag) "yes" else "no");
        debugWrite("/");
    }
    debugWrite(if (network.ntp_reopen_execution_preview.fresh_ready) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_preview.fresh_transport_available) "yes" else "no");
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.predicted_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.predicted_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.predicted_local_port);
    debugWrite(" preview-preserved ");
    debugWrite(if (network.ntp_reopen_execution_preview.preview_preserved) "yes" else "no");
    debugWrite(" execute/match ");
    debugWrite(if (network.ntp_reopen_execution_preview.execution_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_preview.execution_matches_prediction) "yes" else "no");
    debugWrite(" consumed integrity/rejected/reason/preserved ");
    debugWrite(if (network.ntp_reopen_execution_preview.consumed_integrity_valid) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_preview.consumed_preview_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.ntp_reopen_execution_preview.consumed_reason));
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_preview.consumed_state_preserved) "yes" else "no");
    debugWrite(" close ");
    debugWrite(if (network.ntp_reopen_execution_preview.close_clean) "yes" else "no");
    debugWrite(" final IP/TX ");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.final_identification_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.final_tx_cursor);
    debugWrite(" submissions unchanged ");
    debugWrite(if (network.ntp_reopen_execution_preview.tx_submissions_unchanged) "yes" else "no");
    debugWrite(" completions ");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.rx_completion_enqueues);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.final_generation_cursor);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.ingress_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.ingress_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_preview.udp_dispatched);
    debugWrite("\r\n");
    debugWrite("NTP reopen execution plan verified: sockets ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.old_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.old_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.old_local_port);
    debugWrite("->");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.new_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.new_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.new_local_port);
    debugWrite(" server ");
    debugWriteIpv4(network.ntp_reopen_execution_plan.server);
    debugWrite(" initial tag 0x");
    debugWriteHex64(network.ntp_reopen_execution_plan.initial_plan_tag);
    debugWrite("/0x");
    debugWriteHex64(network.ntp_reopen_execution_plan.initial_expected_tag);
    debugWrite(" integrity ");
    for (network.ntp_reopen_execution_plan.initial_integrity_flags, 0..) |flag, index| {
        if (index != 0) debugWrite("/");
        debugWrite(if (flag) "yes" else "no");
    }
    debugWrite(" predicted ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.initial_predicted_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.initial_predicted_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.initial_predicted_port);
    debugWrite(" invalid allocation/tag ");
    for (network.ntp_reopen_execution_plan.invalid_reasons, 0..) |reason, index| {
        if (index != 0) debugWrite("/");
        debugWrite(@tagName(reason));
    }
    debugWrite(" preserved ");
    for (network.ntp_reopen_execution_plan.invalid_preserved, 0..) |preserved, index| {
        if (index != 0) debugWrite("/");
        debugWrite(if (preserved) "yes" else "no");
    }
    debugWrite(" churn ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.churn_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.churn_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.churn_socket_port);
    debugWrite("/closed ");
    debugWrite(if (network.ntp_reopen_execution_plan.churn_closed) "yes" else "no");
    debugWrite(" stale ");
    debugWrite(@tagName(network.ntp_reopen_execution_plan.stale_reason));
    debugWrite(" integrity/preserved ");
    debugWrite(if (network.ntp_reopen_execution_plan.stale_plan_integrity_valid) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan.stale_preserved) "yes" else "no");
    debugWrite(" fresh tag 0x");
    debugWriteHex64(network.ntp_reopen_execution_plan.fresh_plan_tag);
    debugWrite(" integrity ");
    for (network.ntp_reopen_execution_plan.fresh_integrity_flags, 0..) |flag, index| {
        if (index != 0) debugWrite("/");
        debugWrite(if (flag) "yes" else "no");
    }
    debugWrite(" predicted ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.fresh_predicted_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.fresh_predicted_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.fresh_predicted_port);
    debugWrite(" execute/match ");
    debugWrite(if (network.ntp_reopen_execution_plan.execution_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan.execution_matches_plan) "yes" else "no");
    debugWrite(" reused ");
    debugWrite(@tagName(network.ntp_reopen_execution_plan.reused_reason));
    debugWrite(" integrity/preserved ");
    debugWrite(if (network.ntp_reopen_execution_plan.reused_plan_integrity_valid) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan.reused_preserved) "yes" else "no");
    debugWrite(" compatibility ");
    debugWrite(@tagName(network.ntp_reopen_execution_plan.compatibility_reason));
    debugWrite("/preserved ");
    debugWrite(if (network.ntp_reopen_execution_plan.compatibility_preserved) "yes" else "no");
    debugWrite(" close ");
    debugWrite(if (network.ntp_reopen_execution_plan.close_clean) "yes" else "no");
    debugWrite(" final IP/TX ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.final_identification_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.final_tx_cursor);
    debugWrite(" submissions unchanged ");
    debugWrite(if (network.ntp_reopen_execution_plan.tx_submissions_unchanged) "yes" else "no");
    debugWrite(" completions ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.rx_completion_enqueues);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.final_generation_cursor);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.ingress_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.ingress_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan.udp_dispatched);
    debugWrite("\r\n");
    debugWrite("NTP reopen execution plan inspection verified: sockets ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.old_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.old_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.old_local_port);
    debugWrite("->");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.new_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.new_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.new_local_port);
    debugWrite(" server ");
    debugWriteIpv4(network.ntp_reopen_execution_plan_inspection.server);
    debugWrite(" initial consumable/integrity/freshness/ready/allocation/pure ");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.initial_consumable) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.initial_integrity_valid) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.initial_freshness_present) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.initial_freshness_ready) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.initial_allocation_matches) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.initial_pure) "yes" else "no");
    debugWrite(" invalid ");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_inspection.invalid_reason));
    debugWrite(" freshness/cause ");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.invalid_freshness_absent) "absent" else "present");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.invalid_cause_absent) "none" else "present");
    debugWrite(" pure/agree ");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.invalid_pure) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.invalid_execution_agrees) "yes" else "no");
    debugWrite(" stale-service ");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_inspection.stale_service_reason));
    debugWrite("/");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_inspection.stale_service_cause));
    debugWrite(" integrity/freshness/pure/agree ");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.stale_service_integrity_valid) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.stale_service_freshness_present) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.stale_service_pure) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.stale_service_execution_agrees) "yes" else "no");
    debugWrite(" churn ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.churn_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.churn_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.churn_socket_port);
    debugWrite("/closed ");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.churn_closed) "yes" else "no");
    debugWrite(" stale-transport ");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_inspection.stale_transport_reason));
    debugWrite("/");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_inspection.stale_transport_cause));
    debugWrite(" integrity/freshness/pure/agree ");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.stale_transport_integrity_valid) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.stale_transport_freshness_present) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.stale_transport_pure) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.stale_transport_execution_agrees) "yes" else "no");
    debugWrite(" fresh consumable/predicted/pure ");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.fresh_consumable) "yes" else "no");
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.fresh_predicted_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.fresh_predicted_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.fresh_predicted_port);
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.fresh_pure) "yes" else "no");
    debugWrite(" execute/match ");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.execution_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.execution_matches_plan) "yes" else "no");
    debugWrite(" consumed ");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_inspection.consumed_reason));
    debugWrite("/");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_inspection.consumed_cause));
    debugWrite(" integrity/pure/agree ");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.consumed_integrity_valid) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.consumed_pure) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.consumed_execution_agrees) "yes" else "no");
    debugWrite(" close ");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.close_clean) "yes" else "no");
    debugWrite(" final IP/TX ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.final_identification_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.final_tx_cursor);
    debugWrite(" submissions unchanged ");
    debugWrite(if (network.ntp_reopen_execution_plan_inspection.tx_submissions_unchanged) "yes" else "no");
    debugWrite(" completions ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.rx_completion_enqueues);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.final_generation_cursor);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.ingress_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.ingress_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_inspection.udp_dispatched);
    debugWrite("\r\n");
    debugWrite("NTP reopen execution plan refresh verified: sockets ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.old_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.old_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.old_local_port);
    debugWrite("->");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.new_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.new_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.new_local_port);
    debugWrite(" server ");
    debugWriteIpv4(network.ntp_reopen_execution_plan_refresh.server);
    debugWrite(" initial tag 0x");
    debugWriteHex64(network.ntp_reopen_execution_plan_refresh.initial_tag);
    debugWrite(" predicted ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.initial_predicted_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.initial_predicted_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.initial_predicted_port);
    debugWrite(" idempotent reused/not-refreshed/match/pure ");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.idempotent_reused) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.idempotent_not_refreshed) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.idempotent_plan_matches) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.idempotent_pure) "yes" else "no");
    debugWrite(" invalid ");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_refresh.invalid_reason));
    debugWrite(" preview-absent/pure ");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.invalid_preview_absent) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.invalid_pure) "yes" else "no");
    debugWrite(" stale-service ");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_refresh.stale_service_cause));
    debugWrite(" refresh/tag/predicted/snapshot/pure ");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.service_refresh_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.service_refresh_tag_changed) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.service_refresh_predicted_same) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.service_refresh_snapshot_updated) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.service_refresh_pure) "yes" else "no");
    debugWrite(" churn ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.churn_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.churn_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.churn_socket_port);
    debugWrite("/closed ");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.churn_closed) "yes" else "no");
    debugWrite(" stale-transport ");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_refresh.stale_transport_cause));
    debugWrite(" refresh/tag/predicted/pure ");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.transport_refresh_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.transport_refresh_tag_changed) "yes" else "no");
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.transport_refresh_predicted_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.transport_refresh_predicted_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.transport_refresh_predicted_port);
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.transport_refresh_pure) "yes" else "no");
    debugWrite(" execute/match ");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.execution_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.execution_matches_plan) "yes" else "no");
    debugWrite(" consumed cause/rejection/preview-absent/pure ");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_refresh.consumed_original_cause));
    debugWrite("/");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_refresh.consumed_refresh_reason));
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.consumed_preview_absent) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.consumed_pure) "yes" else "no");
    debugWrite(" close ");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.close_clean) "yes" else "no");
    debugWrite(" final IP/TX ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.final_identification_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.final_tx_cursor);
    debugWrite(" submissions unchanged ");
    debugWrite(if (network.ntp_reopen_execution_plan_refresh.tx_submissions_unchanged) "yes" else "no");
    debugWrite(" completions ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.rx_completion_enqueues);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.final_generation_cursor);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.ingress_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.ingress_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_refresh.udp_dispatched);
    debugWrite("\r\n");
    debugWrite("NTP reopen execution deadline refresh verified: sockets ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.old_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.old_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.old_local_port);
    debugWrite("->");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.new_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.new_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.new_local_port);
    debugWrite(" server ");
    debugWriteIpv4(network.ntp_reopen_execution_plan_deadline_refresh.server);
    debugWrite(" clock-anchor ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.clock_anchor_tick);
    debugWrite(" initial ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.initial_deadline_tick);
    debugWrite(" tag 0x");
    debugWriteHex64(network.ntp_reopen_execution_plan_deadline_refresh.initial_tag);
    debugWrite(" predicted ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.initial_predicted_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.initial_predicted_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.initial_predicted_port);
    debugWrite(" same reused/match/pure ");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.same_tick_reused) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.same_tick_plan_matches) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.same_tick_pure) "yes" else "no");
    debugWrite(" backward ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.backward_tick);
    debugWrite("/");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_deadline_refresh.backward_reason));
    debugWrite(" preview-absent/pure ");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.backward_preview_absent) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.backward_pure) "yes" else "no");
    debugWrite(" forward ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.forward_tick);
    debugWrite(" refresh/tag/deadline/predicted/clock/pure ");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.forward_refresh_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.forward_tag_changed) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.forward_deadline_updated) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.forward_predicted_same) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.forward_clock_preserved) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.forward_pure) "yes" else "no");
    debugWrite(" churn ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.churn_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.churn_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.churn_socket_port);
    debugWrite("/closed ");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.churn_closed) "yes" else "no");
    debugWrite(" later ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.later_tick);
    debugWrite(" cause ");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_deadline_refresh.later_original_cause));
    debugWrite(" refresh/tag/deadline/predicted/pure ");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.later_refresh_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.later_tag_changed) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.later_deadline_updated) "yes" else "no");
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.later_predicted_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.later_predicted_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.later_predicted_port);
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.later_pure) "yes" else "no");
    debugWrite(" execute/match ");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.execution_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.execution_matches_plan) "yes" else "no");
    debugWrite(" consumed ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.consumed_tick);
    debugWrite(" cause/rejection/preview-absent/pure ");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_deadline_refresh.consumed_original_cause));
    debugWrite("/");
    debugWrite(@tagName(network.ntp_reopen_execution_plan_deadline_refresh.consumed_reason));
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.consumed_preview_absent) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.consumed_pure) "yes" else "no");
    debugWrite(" close ");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.close_clean) "yes" else "no");
    debugWrite(" final IP/TX ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.final_identification_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.final_tx_cursor);
    debugWrite(" submissions unchanged ");
    debugWrite(if (network.ntp_reopen_execution_plan_deadline_refresh.tx_submissions_unchanged) "yes" else "no");
    debugWrite(" completions ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.rx_completion_enqueues);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.final_generation_cursor);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.ingress_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.ingress_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_execution_plan_deadline_refresh.udp_dispatched);
    debugWrite("\r\n");
    debugWrite("NTP reopen refresh-execute verified: sockets ");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.old_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.old_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.old_local_port);
    debugWrite("->");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.new_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.new_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.new_local_port);
    debugWrite(" server ");
    debugWriteIpv4(network.ntp_reopen_refresh_execution.server);
    debugWrite(" initial ");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.initial_deadline_tick);
    debugWrite(" tag 0x");
    debugWriteHex64(network.ntp_reopen_refresh_execution.initial_tag);
    debugWrite(" predicted ");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.initial_predicted_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.initial_predicted_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.initial_predicted_port);
    debugWrite(" invalid ");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.invalid_tick);
    debugWrite("/");
    debugWrite(@tagName(network.ntp_reopen_refresh_execution.invalid_reason));
    debugWrite(" preview/result-absent ");
    debugWrite(if (network.ntp_reopen_refresh_execution.invalid_preview_absent) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_refresh_execution.invalid_result_absent) "yes" else "no");
    debugWrite(" pure ");
    debugWrite(if (network.ntp_reopen_refresh_execution.invalid_pure) "yes" else "no");
    debugWrite(" fillers ");
    for (network.ntp_reopen_refresh_execution.filler_slots, 0..) |slot, index| {
        if (index != 0) debugWrite(",");
        debugWriteU64Decimal(slot);
        debugWrite("/");
        debugWriteU64Decimal(network.ntp_reopen_refresh_execution.filler_generations[index]);
        debugWrite("/");
        debugWriteU64Decimal(network.ntp_reopen_refresh_execution.filler_ports[index]);
    }
    debugWrite(" full ");
    debugWrite(if (network.ntp_reopen_refresh_execution.table_full) "yes" else "no");
    debugWrite(" unavailable ");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.unavailable_tick);
    debugWrite(" cause/reason ");
    debugWrite(@tagName(network.ntp_reopen_refresh_execution.unavailable_original_cause));
    debugWrite("/");
    debugWrite(@tagName(network.ntp_reopen_refresh_execution.unavailable_reason));
    debugWrite(" preview/result-absent ");
    debugWrite(if (network.ntp_reopen_refresh_execution.unavailable_preview_absent) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_refresh_execution.unavailable_result_absent) "yes" else "no");
    debugWrite(" pure ");
    debugWrite(if (network.ntp_reopen_refresh_execution.unavailable_pure) "yes" else "no");
    debugWrite(" fillers-closed ");
    debugWrite(if (network.ntp_reopen_refresh_execution.fillers_closed) "yes" else "no");
    debugWrite(" success ");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.success_tick);
    debugWrite(" cause ");
    debugWrite(@tagName(network.ntp_reopen_refresh_execution.success_original_cause));
    debugWrite(" refreshed/predicted ");
    debugWrite(if (network.ntp_reopen_refresh_execution.success_refreshed) "yes" else "no");
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.success_predicted_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.success_predicted_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.success_predicted_port);
    debugWrite(" deadline/result/match ");
    debugWrite(if (network.ntp_reopen_refresh_execution.success_deadline_updated) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_refresh_execution.success_result_present) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_refresh_execution.success_matches_plan) "yes" else "no");
    debugWrite(" active ");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.active_tick);
    debugWrite(" cause/reason ");
    debugWrite(@tagName(network.ntp_reopen_refresh_execution.active_original_cause));
    debugWrite("/");
    debugWrite(@tagName(network.ntp_reopen_refresh_execution.active_reason));
    debugWrite(" preview/result-absent ");
    debugWrite(if (network.ntp_reopen_refresh_execution.active_preview_absent) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_refresh_execution.active_result_absent) "yes" else "no");
    debugWrite(" pure ");
    debugWrite(if (network.ntp_reopen_refresh_execution.active_pure) "yes" else "no");
    debugWrite(" close ");
    debugWrite(if (network.ntp_reopen_refresh_execution.close_clean) "yes" else "no");
    debugWrite(" final IP/TX ");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.final_identification_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.final_tx_cursor);
    debugWrite(" submissions unchanged ");
    debugWrite(if (network.ntp_reopen_refresh_execution.tx_submissions_unchanged) "yes" else "no");
    debugWrite(" completions ");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.rx_completion_enqueues);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.final_generation_cursor);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.ingress_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.ingress_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_refresh_execution.udp_dispatched);
    debugWrite("\r\n");
    debugWrite("NTP reopen peer preflight verified: sockets ");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.old_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.old_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.old_local_port);
    debugWrite("->");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.new_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.new_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.new_local_port);
    debugWrite(" server ");
    debugWriteIpv4(network.ntp_reopen_peer_preflight.server);
    debugWrite(" gateway original/zero ");
    debugWrite(if (network.ntp_reopen_peer_preflight.original_gateway_nonzero) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_peer_preflight.gateway_zeroed) "yes" else "no");
    debugWrite(" initial predicted ");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.initial_predicted_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.initial_predicted_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.initial_predicted_port);
    debugWrite(" invalid ");
    debugWrite(@tagName(network.ntp_reopen_peer_preflight.invalid_reason));
    debugWrite(" preflight-absent/pure ");
    debugWrite(if (network.ntp_reopen_peer_preflight.invalid_preflight_absent) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_peer_preflight.invalid_pure) "yes" else "no");
    debugWrite(" combined cause/reason ");
    debugWrite(@tagName(network.ntp_reopen_peer_preflight.combined_original_cause));
    debugWrite("/");
    debugWrite(@tagName(network.ntp_reopen_peer_preflight.combined_reason));
    debugWrite(" preview/result-absent ");
    debugWrite(if (network.ntp_reopen_peer_preflight.combined_preview_absent) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_peer_preflight.combined_result_absent) "yes" else "no");
    debugWrite(" pure ");
    debugWrite(if (network.ntp_reopen_peer_preflight.combined_pure) "yes" else "no");
    debugWrite(" churn ");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.churn_socket_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.churn_socket_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.churn_socket_port);
    debugWrite("/closed ");
    debugWrite(if (network.ntp_reopen_peer_preflight.churn_closed) "yes" else "no");
    debugWrite(" restored ");
    debugWrite(if (network.ntp_reopen_peer_preflight.gateway_restored) "yes" else "no");
    debugWrite(" fresh ready/predicted/pure ");
    debugWrite(if (network.ntp_reopen_peer_preflight.fresh_ready) "yes" else "no");
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.fresh_predicted_slot);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.fresh_predicted_generation);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.fresh_predicted_port);
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_peer_preflight.fresh_pure) "yes" else "no");
    debugWrite(" execute/match ");
    debugWrite(if (network.ntp_reopen_peer_preflight.execution_succeeded) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_peer_preflight.execution_matches_plan) "yes" else "no");
    debugWrite(" active cause/reason ");
    debugWrite(@tagName(network.ntp_reopen_peer_preflight.active_original_cause));
    debugWrite("/");
    debugWrite(@tagName(network.ntp_reopen_peer_preflight.active_reason));
    debugWrite(" preview/result-absent ");
    debugWrite(if (network.ntp_reopen_peer_preflight.active_preview_absent) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.ntp_reopen_peer_preflight.active_result_absent) "yes" else "no");
    debugWrite(" pure ");
    debugWrite(if (network.ntp_reopen_peer_preflight.active_pure) "yes" else "no");
    debugWrite(" close ");
    debugWrite(if (network.ntp_reopen_peer_preflight.close_clean) "yes" else "no");
    debugWrite(" final IP/TX ");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.final_identification_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.final_tx_cursor);
    debugWrite(" submissions unchanged ");
    debugWrite(if (network.ntp_reopen_peer_preflight.tx_submissions_unchanged) "yes" else "no");
    debugWrite(" completions ");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.rx_completion_enqueues);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.final_generation_cursor);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.ingress_enqueued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.ingress_dequeued);
    debugWrite("/");
    debugWriteU64Decimal(network.ntp_reopen_peer_preflight.packets_dispatched);
    debugWrite("/");
    ...
    debugWrite("\r\n");
    debugWrite("TCP foundation verified: protocol ");
    debugWriteU64Decimal(network.tcp_foundation.protocol_number);
    debugWrite(" SYN ");
    debugWriteU64Decimal(network.tcp_foundation.source_port);
    debugWrite("->");
    debugWriteU64Decimal(network.tcp_foundation.destination_port);
    debugWrite(" frame/header/options ");
    debugWriteU64Decimal(network.tcp_foundation.syn_frame_length);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.syn_header_length);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.syn_options_length);
    debugWrite(" seq/flags/window 0x");
    debugWriteHex64(network.tcp_foundation.syn_sequence);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_foundation.syn_flags);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.syn_window);
    debugWrite(" codec ");
    debugWrite(if (network.tcp_foundation.codec_valid) "yes" else "no");
    debugWrite(" invalid-builds ");
    for (network.tcp_foundation.invalid_builds_rejected, 0..) |rejected, index| {
        if (index != 0) debugWrite("/");
        debugWrite(if (rejected) "yes" else "no");
    }
    debugWrite(" parser checksum/fragment/offset/reserved ");
    debugWrite(if (network.tcp_foundation.checksum_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.tcp_foundation.fragment_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.tcp_foundation.offset_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.tcp_foundation.reserved_rejected) "yes" else "no");
    debugWrite(" malformed drop/count ");
    debugWrite(if (network.tcp_foundation.malformed_dispatch_dropped) "yes" else "no");
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.invalid_tcp_dropped);
    debugWrite(" synthetic SYN-ACK seq/ack/flags/window/header/options 0x");
    debugWriteHex64(network.tcp_foundation.syn_ack_sequence);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_foundation.syn_ack_acknowledgement);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_foundation.syn_ack_flags);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.syn_ack_window);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.syn_ack_header_length);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.syn_ack_options_length);
    debugWrite(" routed/queue ");
    debugWrite(if (network.tcp_foundation.valid_dispatch_routed) "yes" else "no");
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.tcp_queue_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.tcp_queue_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.tcp_queue_high_water);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.tcp_queue_dropped);
    debugWrite(" TX ID 0x");
    debugWriteHex64(network.tcp_foundation.transmit_identification);
    debugWrite("->0x");
    debugWriteHex64(network.tcp_foundation.transmit_next_identification);
    debugWrite(" descriptor/cursor/frame ");
    debugWriteU64Decimal(network.tcp_foundation.transmit_descriptor);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.transmit_next_cursor);
    debugWrite("/");
    ...
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.hardware_reply_next_cursor);
    debugWrite(" gateway/source/ports ");
    debugWrite(if (network.tcp_foundation.hardware_reply_source_mac_gateway) "yes" else "no");
    debugWrite("/");
    debugWriteIpv4(network.tcp_foundation.hardware_reply_source_ipv4);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.hardware_reply_source_port);
    debugWrite("->");
    debugWriteU64Decimal(network.tcp_foundation.hardware_reply_destination_port);
    debugWrite(" seq/ack/flags/window/header 0x");
    debugWriteHex64(network.tcp_foundation.hardware_reply_sequence);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_foundation.hardware_reply_acknowledgement);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_foundation.hardware_reply_flags);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.hardware_reply_window);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.hardware_reply_header_length);
    debugWrite(" valid/released ");
    debugWrite(if (network.tcp_foundation.hardware_reply_valid) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.tcp_foundation.hardware_reply_released) "yes" else "no");
    debugWrite(" submissions ");
    debugWriteU64Decimal(network.tcp_foundation.tx_submissions_delta);
    debugWrite(" completions TX/RX ");
    debugWriteU64Decimal(network.tcp_foundation.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.rx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.rx_completion_dequeues);
    debugWrite(" ingress ");
    debugWriteU64Decimal(network.tcp_foundation.ingress_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.ingress_dequeues);
    debugWrite(" dispatch total/TCP/UDP ");
    debugWriteU64Decimal(network.tcp_foundation.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.tcp_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.udp_dispatched);
    debugWrite(" final TX/RX/TCP-ID ");
    debugWriteU64Decimal(network.tcp_foundation.final_tx_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.final_rx_cursor);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_foundation.final_tcp_identification);
    debugWrite(" endpoints/cursor/generation ");
    debugWriteU64Decimal(network.tcp_foundation.final_registered_endpoints);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.final_ephemeral_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_foundation.final_udp_generation);
    debugWrite("\r\n");
    debugWrite("TCP active open verified: states ");
    debugWrite(@tagName(network.tcp_active_open.initial_state));
    debugWrite("->");
    debugWrite(@tagName(network.tcp_active_open.syn_state));
    debugWrite("->");
    debugWrite(@tagName(network.tcp_active_open.established_state));
    debugWrite(" reset/live ");
    debugWrite(@tagName(network.tcp_active_open.reset_state));
    debugWrite("/");
    debugWrite(@tagName(network.tcp_active_open.live_reset_state));
    debugWrite(" ISS/SND.UNA/SND.NXT 0x");
    debugWriteHex64(network.tcp_active_open.initial_sequence);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_active_open.syn_send_unacknowledged);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_active_open.syn_send_next);
    debugWrite(" SYN action/flags/window ");
    debugWrite(@tagName(network.tcp_active_open.syn_action));
    debugWrite("/0x");
    debugWriteHex64(network.tcp_active_open.syn_flags);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_active_open.syn_window);
    debugWrite(" invalid-init/duplicate-open ");
    debugWrite(if (network.tcp_active_open.invalid_init_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.tcp_active_open.duplicate_open_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_active_open.duplicate_open_reason));
    debugWrite(" wrong-ack ");
    debugWrite(if (network.tcp_active_open.wrong_ack_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_active_open.wrong_ack_reason));
    debugWrite("/");
    debugWrite(if (network.tcp_active_open.wrong_ack_preserved) "yes" else "no");
    debugWrite(" simultaneous ");
    debugWrite(if (network.tcp_active_open.simultaneous_open_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_active_open.simultaneous_open_reason));
    debugWrite("/");
    debugWrite(if (network.tcp_active_open.simultaneous_open_preserved) "yes" else "no");
    debugWrite(" established/peer/RCV.NXT/SND.UNA/window ");
    debugWrite(if (network.tcp_active_open.established) "yes" else "no");
    debugWrite("/0x");
    debugWriteHex64(network.tcp_active_open.peer_sequence);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_active_open.receive_next);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_active_open.send_unacknowledged);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_active_open.peer_window);
    debugWrite(" ACK action/seq/ack/flags/window ");
    debugWrite(@tagName(network.tcp_active_open.ack_action));
    debugWrite("/0x");
    debugWriteHex64(network.tcp_active_open.ack_sequence);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_active_open.ack_acknowledgement);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_active_open.ack_flags);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_active_open.ack_window);
    debugWrite(" duplicate-SYN ");
    debugWrite(if (network.tcp_active_open.duplicate_syn_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_active_open.duplicate_syn_reason));
    debugWrite("/");
    debugWrite(if (network.tcp_active_open.duplicate_syn_preserved) "yes" else "no");
    debugWrite(" wrong-RST ");
    debugWrite(if (network.tcp_active_open.wrong_reset_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_active_open.wrong_reset_reason));
    debugWrite("/");
    debugWrite(if (network.tcp_active_open.wrong_reset_preserved) "yes" else "no");
    debugWrite(" reset/live/counts ");
    debugWrite(if (network.tcp_active_open.reset_accepted) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.tcp_active_open.live_rst_accepted) "yes" else "no");
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_active_open.reset_count);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_active_open.live_reset_count);
    debugWrite(" live-ack 0x");
    debugWriteHex64(network.tcp_active_open.live_rst_acknowledgement);
    debugWrite(" wrap ");
    for (network.tcp_active_open.wrap_checks, 0..) |valid, index| {
        if (index != 0) debugWrite("/");
        debugWrite(if (valid) "yes" else "no");
    }
    debugWrite(" packet-free ");
    debugWrite(if (network.tcp_active_open.packet_free) "yes" else "no");
    debugWrite(" completions TX/RX ");
    debugWriteU64Decimal(network.tcp_active_open.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_active_open.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_active_open.rx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_active_open.rx_completion_dequeues);
    debugWrite(" ingress/dispatch ");
    debugWriteU64Decimal(network.tcp_active_open.ingress_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_active_open.ingress_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_active_open.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_active_open.tcp_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_active_open.udp_dispatched);
    debugWrite(" final TX/RX/TCP-ID ");
    debugWriteU64Decimal(network.tcp_active_open.final_tx_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_active_open.final_rx_cursor);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_active_open.final_tcp_identification);
    debugWrite("\r\n");
    debugWrite("TCP retransmission verified: policy ");
    debugWriteU64Decimal(network.tcp_retransmission.initial_timeout_ticks);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.maximum_timeout_ticks);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.maximum_retries);
    debugWrite(" invalid ");
    for (network.tcp_retransmission.invalid_policies_rejected, 0..) |rejected, index| {
        if (index != 0) debugWrite("/");
        debugWrite(if (rejected) "yes" else "no");
    }
    debugWrite(" timer ");
    debugWriteU64Decimal(network.tcp_retransmission.initial_tick);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.initial_deadline);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.initial_interval);
    debugWrite("/");
    debugWrite(if (network.tcp_retransmission.timer_active) "yes" else "no");
    debugWrite(" backward ");
    debugWrite(if (network.tcp_retransmission.backward_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_retransmission.backward_reason));
    debugWrite("/");
    debugWrite(if (network.tcp_retransmission.backward_preserved) "yes" else "no");
    debugWrite(" early ");
    debugWrite(if (network.tcp_retransmission.early_noop) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_retransmission.early_reason));
    debugWrite("/");
    debugWrite(if (network.tcp_retransmission.early_preserved) "yes" else "no");
    debugWrite(" retries ");
    for (network.tcp_retransmission.retry_ticks, 0..) |tick, index| {
        if (index != 0) debugWrite(",");
        debugWriteU64Decimal(tick);
        debugWrite("/");
        debugWriteU64Decimal(network.tcp_retransmission.retry_counts[index]);
        debugWrite("/");
        debugWriteU64Decimal(network.tcp_retransmission.retry_intervals[index]);
        debugWrite("/");
        debugWriteU64Decimal(network.tcp_retransmission.retry_deadlines[index]);
    }
    debugWrite(" exact ");
    for (network.tcp_retransmission.retry_syn_exact, 0..) |exact, index| {
        if (index != 0) debugWrite("/");
        debugWrite(if (exact) "yes" else "no");
    }
    debugWrite(" timeout ");
    debugWriteU64Decimal(network.tcp_retransmission.timeout_tick);
    debugWrite("/");
    debugWrite(@tagName(network.tcp_retransmission.timeout_action));
    debugWrite("/");
    debugWrite(@tagName(network.tcp_retransmission.timeout_state));
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.timeout_retries);
    debugWrite("/");
    debugWrite(if (network.tcp_retransmission.timeout_timer_stopped) "yes" else "no");
    debugWrite(" cancel ");
    debugWrite(if (network.tcp_retransmission.established_timer_cancelled) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.tcp_retransmission.reset_timer_cancelled) "yes" else "no");
    debugWrite(" overflow ");
    debugWriteU64Decimal(network.tcp_retransmission.overflow_start);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.overflow_deadline);
    debugWrite("/");
    debugWrite(if (network.tcp_retransmission.overflow_saturated) "yes" else "no");
    debugWrite(" packet-free ");
    debugWrite(if (network.tcp_retransmission.packet_free) "yes" else "no");
    debugWrite(" counters ");
    debugWriteU64Decimal(network.tcp_retransmission.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.rx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.rx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.ingress_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.ingress_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.tcp_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.udp_dispatched);
    debugWrite(" final ");
    debugWriteU64Decimal(network.tcp_retransmission.final_tx_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_retransmission.final_rx_cursor);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_retransmission.final_tcp_identification);
    debugWrite("\r\n");
    debugWrite("TCP receive-close verified: established ");
    debugWrite(if (network.tcp_receive_close.established) "yes" else "no");
    debugWrite(" RCV.NXT 0x");
    debugWriteHex64(network.tcp_receive_close.initial_receive_next);
    debugWrite(" payload ");
    debugWriteU64Decimal(network.tcp_receive_close.payload_length);
    debugWrite("/");
    debugWrite(@tagName(network.tcp_receive_close.payload_action));
    debugWrite("/0x");
    debugWriteHex64(network.tcp_receive_close.payload_receive_next);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_receive_close.payload_bytes_received);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_receive_close.payload_acknowledgement);
    debugWrite(" duplicate ");
    debugWrite(if (network.tcp_receive_close.duplicate_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_receive_close.duplicate_reason));
    debugWrite("/");
    debugWrite(if (network.tcp_receive_close.duplicate_ack_exact) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.tcp_receive_close.duplicate_preserved) "yes" else "no");
    debugWrite(" out-of-order ");
    debugWrite(if (network.tcp_receive_close.out_of_order_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_receive_close.out_of_order_reason));
    debugWrite("/");
    debugWrite(if (network.tcp_receive_close.out_of_order_ack_exact) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.tcp_receive_close.out_of_order_preserved) "yes" else "no");
    debugWrite(" oversized ");
    debugWrite(if (network.tcp_receive_close.oversized_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_receive_close.oversized_reason));
    debugWrite("/");
    debugWrite(if (network.tcp_receive_close.oversized_preserved) "yes" else "no");
    debugWrite(" passive ");
    debugWriteU64Decimal(network.tcp_receive_close.passive_fin_payload);
    debugWrite("/");
    debugWrite(@tagName(network.tcp_receive_close.passive_state));
    debugWrite("/0x");
    debugWriteHex64(network.tcp_receive_close.passive_receive_next);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_receive_close.passive_bytes_received);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_receive_close.passive_fins_received);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_receive_close.passive_acknowledgement);
    debugWrite(" close ");
    debugWrite(@tagName(network.tcp_receive_close.passive_close_state));
    debugWrite("/0x");
    debugWriteHex64(network.tcp_receive_close.passive_fin_sequence);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_receive_close.passive_send_next);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_receive_close.passive_fins_sent);
    debugWrite(" final ");
    debugWrite(@tagName(network.tcp_receive_close.passive_final_state));
    debugWrite("/");
    debugWrite(if (network.tcp_receive_close.passive_closed) "yes" else "no");
    debugWrite(" active ");
    debugWrite(@tagName(network.tcp_receive_close.active_close_state));
    debugWrite("/0x");
    debugWriteHex64(network.tcp_receive_close.active_fin_sequence);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_receive_close.active_send_next);
    debugWrite(" wrong-ack ");
    debugWrite(if (network.tcp_receive_close.wrong_fin_ack_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_receive_close.wrong_fin_ack_reason));
    debugWrite("/");
    debugWrite(if (network.tcp_receive_close.wrong_fin_ack_preserved) "yes" else "no");
    debugWrite(" ACK ");
    debugWrite(@tagName(network.tcp_receive_close.fin_ack_state));
    debugWrite(" remote ");
    debugWrite(@tagName(network.tcp_receive_close.remote_fin_state));
    debugWrite("/0x");
    debugWriteHex64(network.tcp_receive_close.remote_fin_acknowledgement);
    debugWrite(" duplicate-FIN ");
    debugWrite(if (network.tcp_receive_close.duplicate_fin_rejected) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_receive_close.duplicate_fin_reason));
    debugWrite("/");
    debugWrite(if (network.tcp_receive_close.duplicate_fin_ack_exact) "yes" else "no");
    debugWrite("/");
    debugWrite(if (network.tcp_receive_close.duplicate_fin_preserved) "yes" else "no");
    debugWrite(" expire ");
    debugWrite(if (network.tcp_receive_close.time_wait_expired) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_receive_close.active_final_state));
    debugWrite(" simultaneous ");
    debugWrite(if (network.tcp_receive_close.simultaneous_close) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_receive_close.simultaneous_state));
    debugWrite(" reset ");
    debugWrite(if (network.tcp_receive_close.reset_compatible) "yes" else "no");
    debugWrite("/");
    debugWrite(@tagName(network.tcp_receive_close.reset_state));
    debugWrite(" packet-free ");
    debugWrite(if (network.tcp_receive_close.packet_free) "yes" else "no");
    debugWrite(" counters ");
    debugWriteU64Decimal(network.tcp_receive_close.tx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_receive_close.tx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_receive_close.rx_completion_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_receive_close.rx_completion_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_receive_close.ingress_enqueues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_receive_close.ingress_dequeues);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_receive_close.packets_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_receive_close.tcp_dispatched);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_receive_close.udp_dispatched);
    debugWrite(" final-transport ");
    debugWriteU64Decimal(network.tcp_receive_close.final_tx_cursor);
    debugWrite("/");
    debugWriteU64Decimal(network.tcp_receive_close.final_rx_cursor);
    debugWrite("/0x");
    debugWriteHex64(network.tcp_receive_close.final_tcp_identification);
    debugWrite("\r\n");
