...
try {
    ...
    $required = @(
        ...
        $(if ($Network) { ' backing alloc/release/fail 54/54/0/0' } else { ' backing alloc/release/fail 49/49/0/0' }),
        ...
        $(if ($Network) { 'alloc/free 332/332 failed/rejected 0/0 clean yes' } else { 'alloc/free 296/296 failed/rejected 0/0 clean yes' }),
