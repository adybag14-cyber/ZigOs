...
try {
    ...
    $required = @(
        ...
        $(if ($Network) { 'alloc/free 339/339 failed/rejected 0/0 clean yes' } else { 'alloc/free 303/303 failed/rejected 0/0 clean yes' }),
        ...
        $(if ($Network) { 'reclaimed 281 stale-contexts-swept 0 allocator alloc/release/retains 281/281/0' } else { 'reclaimed 250 stale-contexts-swept 0 allocator alloc/release/retains 250/250/0' }),
