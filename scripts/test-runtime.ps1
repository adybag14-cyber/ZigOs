...
try {
    ...
    $required = @(
        ...
        $(if ($Network) { ' backing alloc/release/fail 57/57/0/0' } else { ' backing alloc/release/fail 52/52/0/0' }),
        ...
        $(if ($Network) { 'alloc/free 337/337 failed/rejected 0/0 clean yes' } else { 'alloc/free 301/301 failed/rejected 0/0 clean yes' }),
