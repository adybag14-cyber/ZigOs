...
try {
    ...
    $required = @(
        ...
        ' page-write tickets/outstanding 362/0',
        ...
        'ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5803076 metadata/file/block reads 113/4/115 failures 0 clusters claimed/free/loop/cross/range 11338/4773/0/0/0 lock tickets/outstanding 5/0 quarantine state/reason/events no/none/0 clean yes',
