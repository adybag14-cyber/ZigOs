...
if ($Network) {
    ...
    if (-not $output.Contains('NTP reopen reason matrix verified: sockets 2/100/49239->2/101/49240 server 10.0.2.4, live service_active/client_active/request_active/transport_still_active policy invalid_refresh_interval/invalid_quality_policy/invalid_quality_rejection_policy/invalid_step_policy/invalid_step_rejection_policy/invalid_retry_policy/invalid_recovery_policy/backward_refresh_tick source missing_source_rotation_policy/invalid_source_pool/invalid_source_rotation_policy/source_count_mismatch/source_index_out_of_range/retained_server_mismatch/unexpected_source_rotation_policy/unexpected_source_index/invalid_server exact/snapshots/cursors yes/yes/yes failure cursors 49240/101 reopen/no-rejection yes/yes legacy rejected/preserved yes/yes close yes final IP/TX 166/1 submissions unchanged yes completions 193/193/22 endpoints/cursor/generation 2/49241/102 ingress/dispatch 211/211/199/198')) {
