...
if ($Network) {
    ...
    if (-not [regex]::IsMatch($output, 'NTP reopen allocation failure verified: source (HPET|ACPI PM timer), frequency/bits [1-9][0-9]*/(24|32|64), old socket 2/94/49235 server 10.0.2.4, loss discarded/queue 0/0/0/0/0 abandon yes fillers 2/95/55001\+3/96/55002 full yes failure cursors 49236/97 rejected/service/device yes/yes/yes reason transport_unavailable released yes reopen socket 2/97/49236 succeeded/state/transient yes/yes/yes initial 163/6/7 started yes sample/time [1-9][0-9]*/1800000000/0x80000000 accepted yes health sync/cumulative yes/yes close yes lifecycle 6/4/4 quality 3/1 step 3/1 final IP/TX 164/7 submissions/completions 1/191/191/22 endpoints/cursor/generation 2/49237/98 ingress/dispatch 209/209/197/196')) {
        throw 'NTP transport reopen allocation failure consumed cursors or mutated service/device state, filler release did not restore capacity, or the later successful reopen and synchronization drifted from exact HPET/ACPI PM timer accounting.'
    }
    if (-not [regex]::IsMatch($output, 'NTP reopen validation failure verified: source (HPET|ACPI PM timer), frequency/bits [1-9][0-9]*/(24|32|64), sockets 2/98/49237->2/99/49238 server 10.0.2.4, initial 164/7/0 sample [1-9][0-9]* synchronized yes loss discarded/queue 0/1/1/1/0 abandon yes failures backward/server/retry/rotation yes/yes/yes/yes reasons backward_refresh_tick/retained_server_mismatch/invalid_retry_policy/invalid_source_rotation_policy snapshots/cursors yes/yes failure cursors 49238/99 reopen succeeded/state/transient yes/yes/yes refresh timestamp 0x[0-9A-F]{16} TX 165/0/1 started yes sample/time [1-9][0-9]*/1800000002/0x80000000 accepted yes health sync/source yes/yes close yes lifecycle 2/0/2 quality 2/0 step 2/0 final IP/TX 166/1 submissions/completions 2/193/193/22 endpoints/cursor/generation 2/49239/100 ingress/dispatch 211/211/199/198')) {
        throw 'NTP transport reopen validation failure mutated service/device state or consumed cursors before allocation, or the restored valid service failed to reopen, refresh, synchronize, and close with exact HPET/ACPI PM timer accounting.'
    }
    if (-not $output.Contains('NTP reopen reason matrix verified: sockets 2/100/49239->2/102/49240 server 10.0.2.4, live service_active/client_active/request_active/transport_still_active policy invalid_refresh_interval/invalid_quality_policy/invalid_quality_rejection_policy/invalid_step_policy/invalid_step_rejection_policy/invalid_retry_policy/invalid_recovery_policy/backward_refresh_tick source missing_source_rotation_policy/invalid_source_pool/invalid_source_rotation_policy/source_count_mismatch/source_index_out_of_range/retained_server_mismatch/unexpected_source_rotation_policy/unexpected_source_index/invalid_server exact/snapshots/cursors yes/yes/yes failure cursors 49240/101 inspect ready/target/state/device yes/yes/yes/yes stale-service stale_service_state/preserved yes/yes churn 2/101/55003/closed yes stale-transport stale_transport_state/preserved yes/yes reinspect ready/match yes/yes execute/no-rejection/match yes/yes/yes single-use stale_service_state/preserved yes legacy rejected/preserved yes/yes close yes final IP/TX 166/1 submissions unchanged yes completions 193/193/22 endpoints/cursor/generation 2/49241/103 ingress/dispatch 211/211/199/198')) {
        throw 'The NTP reopen plan did not reject stale service or transport state before allocation, fresh reinspection/execution drifted, the consumed plan was reusable, or packet-free accounting changed.'
    }
    if (-not [regex]::IsMatch($output, 'NTP reopen plan integrity verified: sockets 2/103/49241->2/104/49242 server 10\.0\.2\.4 tag 0x[0-9A-F]{16} tampered tag/socket/server/source/clock/deadline/service/transport invalid_preflight_plan/invalid_preflight_plan/invalid_preflight_plan/invalid_preflight_plan/invalid_preflight_plan/invalid_preflight_plan/invalid_preflight_plan/invalid_preflight_plan rejected/snapshots yes/yes/yes execute/match yes/yes consumed stale_service_state/preserved yes close yes final IP/TX 166/1 submissions unchanged yes completions 193/193/22 endpoints/cursor/generation 2/49243/105 ingress/dispatch 211/211/199/198')) {
        throw 'The NTP reopen plan integrity tag did not reject all altered executable fields and snapshots before mutation, untouched execution drifted, or packet-free accounting changed.'
    }
    if (-not [regex]::IsMatch($output, 'NTP reopen plan inspection verified: sockets 2/105/49243->2/106/49244 server 10\.0\.2\.4 original actual/expected/valid 0x([0-9A-F]{16})/0x\1/yes tampered tag/deadline/service/transport invalid yes/yes/yes/yes different yes/yes/yes/yes pure state/device yes/yes execute/match yes/yes consumed integrity/execution/reason/preserved yes/yes/stale_service_state/yes close yes final IP/TX 166/1 submissions unchanged yes completions 193/193/22 endpoints/cursor/generation 2/49245/107 ingress/dispatch 211/211/199/198')) {
        throw 'Pure NTP reopen plan integrity inspection mutated runtime state, failed to distinguish altered tags from stale execution, or changed packet-free accounting.'
    }
    if (-not [regex]::IsMatch($output, 'NTP reopen plan freshness verified: sockets 2/107/49245->2/109/49246 server 10\.0\.2\.4 initial ready/flags yes/yes/yes/yes/yes invalid invalid_preflight_plan flags no/no/no/no stale-service stale_service_state flags yes/no/no/no churn 2/108/55004/closed yes stale-transport stale_transport_state flags yes/yes/no/no preserved yes/yes/yes reinspection ready/flags yes/yes/yes/yes/yes execute/match yes/yes consumed integrity/freshness/reason/preserved yes/yes/stale_service_state/yes close yes final IP/TX 166/1 submissions unchanged yes completions 193/193/22 endpoints/cursor/generation 2/49247/110 ingress/dispatch 211/211/199/198')) {
        throw 'Pure NTP reopen plan freshness inspection did not preserve ordered integrity/service/transport/canonical gates, allocate only after fresh reinspection, or retain packet-free accounting.'
    }
    if (-not [regex]::IsMatch($output, 'NTP reopen execution preview verified: sockets 2/110/49247->2/113/49248 server 10\.0\.2\.4 fillers 2/111/55005,3/112/55006 saturated freshness yes/yes/yes/yes/yes unavailable transport_unavailable no-socket/preview-preserved/execution-rejected/execution-preserved yes/yes/yes/yes fillers-closed yes released stale_transport_state no-socket/preserved yes/yes fresh flags/ready/available/predicted yes/yes/yes/yes/yes/yes/2/113/49248 preview-preserved yes execute/match yes/yes consumed integrity/rejected/reason/preserved yes/yes/stale_service_state/yes close yes final IP/TX 166/1 submissions unchanged yes completions 193/193/22 endpoints/cursor/generation 2/49249/114 ingress/dispatch 211/211/199/198')) {
        throw 'NTP reopen execution preview failed to predict exact ephemeral allocation, mirror saturated execution rejection, invalidate after capacity churn, or preserve packet-free state.'
    }
    if (-not [regex]::IsMatch($output, 'NTP reopen execution plan verified: sockets 2/114/49249->2/116/49250 server 10\.0\.2\.4 initial tag 0x([0-9A-F]{16})/0x\1 integrity yes/yes/yes predicted 2/115/49250 invalid allocation/tag invalid_execution_preview/invalid_execution_preview preserved yes/yes churn 2/115/55007/closed yes stale stale_execution_preview integrity/preserved yes/yes fresh tag 0x[0-9A-F]{16} integrity yes/yes/yes predicted 2/116/49250 execute/match yes/yes reused stale_execution_preview integrity/preserved yes/yes compatibility stale_service_state/preserved yes close yes final IP/TX 166/1 submissions unchanged yes completions 193/193/22 endpoints/cursor/generation 2/49251/117 ingress/dispatch 211/211/199/198')) {
        throw 'Consumable NTP reopen execution plans did not distinguish invalid versus stale previews, match exact allocation, reject reuse, or preserve legacy preflight behavior.'
    }
    if (-not [regex]::IsMatch($output, 'NTP reopen execution plan inspection verified: sockets 2/117/49251->2/119/49252 server 10\.0\.2\.4 initial consumable/integrity/freshness/ready/allocation/pure yes/yes/yes/yes/yes/yes invalid invalid_execution_preview freshness/cause absent/none pure/agree yes/yes stale-service stale_execution_preview/stale_service_state integrity/freshness/pure/agree yes/yes/yes/yes churn 2/118/55008/closed yes stale-transport stale_execution_preview/stale_transport_state integrity/freshness/pure/agree yes/yes/yes/yes fresh consumable/predicted/pure yes/2/119/49252/yes execute/match yes/yes consumed stale_execution_preview/stale_service_state integrity/pure/agree yes/yes/yes close yes final IP/TX 166/1 submissions unchanged yes completions 193/193/22 endpoints/cursor/generation 2/49253/120 ingress/dispatch 211/211/199/198')) {
        throw 'Pure NTP reopen execution-plan inspection did not expose invalid and stale causes, agree with execution, preserve state, or retain exact packet-free accounting.'
    }
    if (-not [regex]::IsMatch($output, 'NTP reopen execution plan refresh verified: sockets 2/120/49253->2/122/49254 server 10\.0\.2\.4 initial tag 0x[0-9A-F]{16} predicted 2/121/49254 idempotent reused/not-refreshed/match/pure yes/yes/yes/yes invalid invalid_execution_preview preview-absent/pure yes/yes stale-service stale_service_state refresh/tag/predicted/snapshot/pure yes/yes/yes/yes/yes churn 2/121/55009/closed yes stale-transport stale_transport_state refresh/tag/predicted/pure yes/yes/2/122/49254/yes execute/match yes/yes consumed cause/rejection/preview-absent/pure stale_service_state/service_active/yes/yes close yes final IP/TX 166/1 submissions unchanged yes completions 193/193/22 endpoints/cursor/generation 2/49255/123 ingress/dispatch 211/211/199/198')) {
        throw 'NTP reopen execution-plan refresh did not reuse current plans, reissue stale service/transport plans without mutation, consume exact allocation, or reject active state.'
    }
    if (-not [regex]::IsMatch($output, 'NTP reopen execution deadline refresh verified: sockets 2/123/49255->2/125/49256 server 10\.0\.2\.4 clock-anchor 175 initial 180 tag 0x[0-9A-F]{16} predicted 2/124/49256 same reused/match/pure yes/yes/yes backward 174/backward_refresh_tick preview-absent/pure yes/yes forward 185 refresh/tag/deadline/predicted/clock/pure yes/yes/yes/yes/yes/yes churn 2/124/55010/closed yes later 190 cause stale_transport_state refresh/tag/deadline/predicted/pure yes/yes/yes/2/125/49256/yes execute/match yes/yes consumed 195 cause/rejection/preview-absent/pure stale_service_state/service_active/yes/yes close yes final IP/TX 166/1 submissions unchanged yes completions 193/193/22 endpoints/cursor/generation 2/49257/126 ingress/dispatch 211/211/199/198')) {
        throw 'Deadline-aware NTP reopen plan refresh did not preserve same-tick identity, reject backward synchronized ticks, retag forward deadlines, or update exact allocation after churn.'
    }
    if (-not [regex]::IsMatch($output, 'NTP reopen refresh-execute verified: sockets 2/126/49257->2/129/49258 server 10\.0\.2\.4 initial 211 tag 0x[0-9A-F]{16} predicted 2/127/49258 invalid 212/invalid_execution_preview preview/result-absent yes/yes pure yes fillers 2/127/55011,3/128/55012 full yes unavailable 215 cause/reason stale_transport_state/transport_unavailable preview/result-absent yes/yes pure yes fillers-closed yes success 220 cause stale_transport_state refreshed/predicted yes/2/129/49258 deadline/result/match yes/yes/yes active 225 cause/reason stale_service_state/service_active preview/result-absent yes/yes pure yes close yes final IP/TX 166/1 submissions unchanged yes completions 193/193/22 endpoints/cursor/generation 2/49259/130 ingress/dispatch 211/211/199/198')) {
        throw 'Transactional NTP reopen refresh-and-execute did not stop before mutation on invalid/full transport, consume exact refreshed allocation after release, or reject active reuse.'
    }
    if (-not [regex]::IsMatch($output, 'NTP reopen peer preflight verified: sockets 2/130/49259->2/132/49260 server 10\.0\.2\.4 gateway original/zero yes/yes initial predicted 2/131/49260 invalid invalid_transport_peer preflight-absent/pure yes/yes combined cause/reason stale_transport_state/invalid_transport_peer preview/result-absent yes/yes pure yes churn 2/131/55013/closed yes restored yes fresh ready/predicted/pure yes/2/132/49260/yes execute/match yes/yes active cause/reason stale_service_state/service_active preview/result-absent yes/yes pure yes close yes final IP/TX 166/1 submissions unchanged yes completions 193/193/22 endpoints/cursor/generation 2/49261/133 ingress/dispatch 211/211/199/198')) {
        throw 'NTP reopen peer preflight did not reject a zero gateway before allocation, propagate through refresh-execute, recover exact allocation after restoration, or preserve packet-free state.'
    }
    if (-not [regex]::IsMatch($output, 'NTP reopen protected peer verified: sockets 2/133/49261->2/134/49262 server 10\.0\.2\.4 peer gateway/server/port yes/yes/123 initial tag 0x906B8F357A4A7C85 integrity yes/yes/yes/yes/yes preview-pure yes forged tag yes/yes/yes peer no/no/no valid no/no/no reasons invalid_execution_preview/invalid_execution_preview/invalid_execution_preview preserved yes/yes/yes execute/bound/match/client/result yes/yes/yes/yes/yes active stale_execution_preview integrity/preserved yes/yes close yes final IP/TX 166/1 submissions unchanged yes completions 193/193/22 endpoints/cursor/generation 2/49263/135 ingress/dispatch 211/211/199/198')) {
        throw 'NTP reopen execution plans did not bind the exact gateway/server/port peer, reject correctly re-tagged peer forgeries before allocation, or preserve packet-free state.'
    }
    if (-not [regex]::IsMatch($output, 'TCP foundation verified: protocol 6 SYN 50000->443 frame/header/options 66/32/12 seq/flags/window 0x0000000013579BDF/0x0000000000000002/64240 codec yes invalid-builds yes/yes/yes parser checksum/fragment/offset/reserved yes/yes/yes/yes malformed drop/count yes/1 synthetic SYN-ACK seq/ack/flags/window/header/options 0x000000002468ACE0/0x0000000013579BE0/0x0000000000000012/32768/24/4 routed/queue yes/1/1/1/0 TX ID 0x0000000000007200->0x0000000000007201 descriptor/cursor/frame 1/2/66 advanced yes live RST-ACK frame/descriptor/cursor 60/6/7 gateway/source/ports yes/192\.0\.2\.1/443->50000 seq/ack/flags/window/header 0x0000000000000000/0x0000000013579BE0/0x0000000000000014/0/20 valid/released yes/yes submissions 1 completions TX/RX 194/194/23/23 ingress 213/213 dispatch total/TCP/UDP 200/1/198 final TX/RX/TCP-ID 2/7/0x0000000000007201 endpoints/cursor/generation 2/49263/135')) {
        throw 'Native TCP framing, parser rejection, dispatch routing, transactional transmission, or live SYN-to-RST/ACK hardware round trip failed.'
    }
    if (-not [regex]::IsMatch($output, 'TCP active open verified: states closed->syn_sent->established reset/live reset/reset ISS/SND\.UNA/SND\.NXT 0x0000000013579BDF/0x0000000013579BDF/0x0000000013579BE0 SYN action/flags/window send_syn/0x0000000000000002/64240 invalid-init/duplicate-open yes/yes/invalid_state wrong-ack yes/invalid_acknowledgement/yes simultaneous yes/unsupported_simultaneous_open/yes established/peer/RCV\.NXT/SND\.UNA/window yes/0x000000002468ACE0/0x000000002468ACE1/0x0000000013579BE0/32768 ACK action/seq/ack/flags/window send_ack/0x0000000013579BE0/0x000000002468ACE1/0x0000000000000010/64240 duplicate-SYN yes/invalid_segment/yes wrong-RST yes/unexpected_sequence/yes reset/live/counts yes/yes/1/1 live-ack 0x0000000013579BE0 wrap yes/yes/yes packet-free yes completions TX/RX 194/194/23/23 ingress/dispatch 213/213/200/1/198 final TX/RX/TCP-ID 2/7/0x0000000000007201')) {
        throw 'TCP active-open state transitions, immutable rejection paths, wrap-safe sequence comparisons, or live RST handling failed.'
    }
    if (-not [regex]::IsMatch($output, 'TCP retransmission verified: policy 3/10/3 invalid yes/yes/yes timer 100/103/3/yes backward yes/backward_tick/yes early yes/before_deadline/yes retries 103/1/6/109,109/2/10/119,119/3/10/129 exact yes/yes/yes timeout 129/timed_out/timed_out/3/yes cancel yes/yes overflow 18446744073709551613/18446744073709551615/yes packet-free yes counters 194/194/23/23/213/213/200/1/198 final 2/7/0x0000000000007201')) {
        throw 'TCP retransmission policy, deadline handling, capped backoff, timeout, cancellation, or overflow saturation failed.'
    }
    if (-not [regex]::IsMatch($output, 'TCP receive-close verified: established yes RCV\.NXT 0x000000002468ACE1 payload 5/send_ack/0x000000002468ACE6/5/0x000000002468ACE6 duplicate yes/duplicate_segment/yes/yes out-of-order yes/unexpected_sequence/yes/yes oversized yes/segment_outside_window/yes passive 3/close_wait/0x000000002468ACEA/8/1/0x000000002468ACEA close last_ack/0x0000000013579BE0/0x0000000013579BE1/1 final closed/yes active fin_wait_1/0x0000000013579BE0/0x0000000013579BE1 wrong-ack yes/invalid_acknowledgement/yes ACK fin_wait_2 remote time_wait/0x000000002468ACE2 duplicate-FIN yes/duplicate_segment/yes/yes expire yes/closed simultaneous yes/time_wait reset yes/reset packet-free yes counters 194/194/23/23/213/213/200/1/198 final-transport 2/7/0x0000000000007201')) {
        throw 'TCP receive sequencing, duplicate/out-of-order ACK behavior, window enforcement, FIN lifecycle, TIME-WAIT expiry, or reset compatibility failed.'
    }
