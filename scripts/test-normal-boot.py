    ...
    with stdout_log.open("wb") as stdout_stream, stderr_log.open("wb") as stderr_stream:
        ...
        try:
            ...
            required = (
                ...
                " metadata/file/block reads 111/0/111 failures 0 clusters claimed/free/loop/cross/range 10845/5266/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes",
