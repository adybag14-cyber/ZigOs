    ...
    with stdout_log.open("wb") as stdout_stream, stderr_log.open("wb") as stderr_stream:
        ...
        try:
            ...
            required = (
                ...
                " metadata/file/block reads 113/0/113 failures 0 clusters claimed/free/loop/cross/range 11346/4765/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes",
