...
$commandPlan = @(
    ...
    @{ Command = 'ps'; Expect = 'PID 0x00000004 EXITED 0x00000033 INIT.ELF' },
...
$vfsReadyMarker = 'ZigOs i686 VFS/process ready: mount FAT12 root-files 0x00000002 fd-capacity 0x00000004 probe-fd 0x00000000 split-read 0x00000020/0x00000036 process-capacity 0x00000008 PID1 exited 0x00000033'
...
$vfsFinalMarker = 'ZigOs i686 VFS/process verified: opens 0x00000003 reads 0x00000004 closes 0x00000003 processes 0x00000004 last-pid 0x00000004 last-exit 0x00000033 descriptors-closed yes'
...
$debugMarkers = @(
    ...
    'PID 0x00000004 EXITED 0x00000033 INIT.ELF',
