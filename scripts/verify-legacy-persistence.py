#!/usr/bin/env python3
"""Verify the on-disk NOTES.TXT mutation produced by Capstone 11 userspace."""
...
def main() -> None:
    ...
    print("Verified Capstone 11 persistent FAT12 mutation")
    print("  NOTES.TXT: root slot 11, 720 bytes, clusters 23->24->EOC")
