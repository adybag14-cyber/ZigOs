...
def main() -> int:
    ...
    require(readme, "Size:    5,649,920 bytes", "README carries the reproducible G269 ABI 1.23 EFI size")
    require(readme, "SHA-256: 49447E3237F994F8395352B301E187D1B35F71ED205E892FBF5A27D2FFCC0F5E", "README carries the reproducible G269 ABI 1.23 EFI hash")
    ...
    require(roadmap, "223 complete, 277 open", "roadmap arithmetic includes G269")
    ...
    if len(roadmap_items) != 500 or sum(item == "x" for item in roadmap_items) != 223:
        raise SystemExit("roadmap must contain 500 goals with exactly 223 complete after G269")
