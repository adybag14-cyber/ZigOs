...
def main() -> int:
    ...
    require(normal_boot_test, "alloc/free 381/381 cache-released 15 storage persistent clean yes", "normal QEMU gate requires exact G269 physical reclamation and persistent mode")
    ...
    require(readme, "Size:    5,649,920 bytes", "README carries the reproducible G270 ABI 1.23 EFI size")
    require(readme, "SHA-256: 5EC1248D4A3AC8B247D0EB6F8D5C2A00A21DC1254E961BBB6D9B7015070AE46B", "README carries the reproducible G270 ABI 1.23 EFI hash")
    ...
    require(roadmap, "224 complete, 276 open", "roadmap arithmetic includes G270")
    ...
    if len(roadmap_items) != 500 or sum(item == "x" for item in roadmap_items) != 224:
        raise SystemExit("roadmap must contain 500 goals with exactly 224 complete after G270")
