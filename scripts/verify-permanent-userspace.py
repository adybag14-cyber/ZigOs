...
def main() -> int:
    ...
    require(roadmap, "210 complete, 290 open", "roadmap arithmetic includes G250")
    ...
    if len(roadmap_items) != 500 or sum(item == "x" for item in roadmap_items) != 210:
        raise SystemExit("roadmap must contain 500 goals with exactly 210 complete after G250")
