...
def main() -> int:
    ...
    require(normal_boot_test, "alloc/free 300/300 cache-released 16 storage persistent clean yes", "normal QEMU gate requires exact G265 physical reclamation and persistent mode")
    ...
    require(sdk_shell, "fn spawnResolvedGroup(", "G264 centralizes grouped spawn selection")
