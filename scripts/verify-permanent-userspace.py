...
def main() -> int:
    ...
    require(normal_boot_test, "alloc/free 484/484 cache-released 13 storage persistent clean yes", "normal QEMU gate requires exact G274 physical reclamation and persistent mode")
    ...
    require(io_error_boot_test, "10967/5144/0/0/0 lock tickets/outstanding 4/0 quarantine state/reason/events no/none/0 clean yes", "G274 EIO recovery retains measured private-build FAT ownership")
    ...
    require(readonly_remount_boot_test, "10967/5144/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes", "G274 contained persistent-write profile retains measured private-build FAT ownership")
    ...
    require(runtime_test, "11067/5044/0/0/0 lock tickets/outstanding 5/0 quarantine state/reason/events no/none/0 clean yes", "both G247 diagnostic QEMU profiles require exact global FAT ownership with zero classified corruption")
    ...
    require(normal_boot_test, "10967/5144/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes", "G274 normal QEMU requires exact FAT ownership with zero classified corruption")
    ...
    require(runtime_test, "page-write tickets/outstanding 202/0", "both diagnostic QEMU profiles require the measured page-writer ticket total with no outstanding lock")
    ...
    require(readme, "Size:    5,664,256 bytes", "README carries the reproducible G274 ABI 1.24 EFI size")
    require(readme, "SHA-256: 4FE4BDE4D9646E039D922E30C53FB392AC8049F1E6A40919CE27CDD63E2DD472", "README carries the reproducible G274 ABI 1.24 EFI hash")
    ...
    require(runtime_test, "bytes 5664324 metadata/file/block reads 112/4/114 failures 0 clusters claimed/free/loop/cross/range 11067/5044/0/0/0", "G247 diagnostic harness freezes the measured FAT geometry")
    require(normal_boot_test, "10967/5144/0/0/0 lock tickets/outstanding 1/0", "G274 normal harness freezes the measured FAT geometry")
    require(io_error_boot_test, "bytes 5613124 metadata/file/block reads 112/3/113 failures 1 clusters claimed/free/loop/cross/range 10967/5144/0/0/0", "G264 read-EIO harness freezes its private fault-injection geometry")
    require(readonly_remount_boot_test, "bytes 5613124 metadata/file/block reads 111/0/111 failures 0 clusters claimed/free/loop/cross/range 10967/5144/0/0/0", "G264 write-EIO harness freezes its private fault-injection geometry")
    ...
    require(roadmap, "228 complete, 272 open", "roadmap arithmetic includes G274")
    ...
    if len(roadmap_items) != 500 or sum(item == "x" for item in roadmap_items) != 228:
        raise SystemExit("roadmap must contain 500 goals with exactly 228 complete after G274")
