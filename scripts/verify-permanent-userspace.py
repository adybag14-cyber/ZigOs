...
def main() -> int:
    ...
    require(normal_boot_test, "alloc/free 344/344 cache-released 16 storage persistent clean yes", "normal QEMU gate requires exact G267 physical reclamation and persistent mode")
    ...
    require(readme, "Size:    5,649,920 bytes", "README carries the reproducible G267 ABI 1.23 EFI size")
    require(readme, "SHA-256: 15294206DDFDB637AE932E873924314DB554DFE42B2BED9683B0D8027A399D14", "README carries the reproducible G267 ABI 1.23 EFI hash")
    ...
    require(roadmap, "221 complete, 279 open", "roadmap arithmetic includes G267")
    ...
    require(sdk_shell, "if (isBuiltin(stage.slice(0)) or assignmentNameLength(stage.slice(0)) != null) return false;", "G267 rejects background assignment stages during prevalidation")
    ...
    if len(roadmap_items) != 500 or sum(item == "x" for item in roadmap_items) != 221:
        raise SystemExit("roadmap must contain 500 goals with exactly 221 complete after G267")
