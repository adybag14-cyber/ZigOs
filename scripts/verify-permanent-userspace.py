...
def main() -> int:
    ...
    require(normal_boot_test, "alloc/free 501/501 cache-released 13 storage persistent clean yes", "normal QEMU gate requires exact G275 physical reclamation and persistent mode")
    ...
    require(io_error_boot_test, "10979/5132/0/0/0 lock tickets/outstanding 4/0 quarantine state/reason/events no/none/0 clean yes", "G275 EIO recovery retains measured private-build FAT ownership")
    ...
    require(readonly_remount_boot_test, "10979/5132/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes", "G275 contained persistent-write profile retains measured private-build FAT ownership")
    ...
    require(runtime_test, "11080/5031/0/0/0 lock tickets/outstanding 5/0 quarantine state/reason/events no/none/0 clean yes", "both G247 diagnostic QEMU profiles require exact global FAT ownership with zero classified corruption")
    ...
    require(normal_boot_test, "10979/5132/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes", "G275 normal QEMU requires exact FAT ownership with zero classified corruption")
    ...
    require(readme, "Size:    5,670,912 bytes", "README carries the reproducible G275 ABI 1.24 EFI size")
    require(readme, "SHA-256: 595454B6CA3C2ECA54BF0F1BA885D342D25558BA7C6B51B6C33016D9B81D0FA6", "README carries the reproducible G275 ABI 1.24 EFI hash")
    ...
    require(runtime_test, "bytes 5670980 metadata/file/block reads 112/4/114 failures 0 clusters claimed/free/loop/cross/range 11080/5031/0/0/0", "G247 diagnostic harness freezes the measured FAT geometry")
    require(normal_boot_test, "10979/5132/0/0/0 lock tickets/outstanding 1/0", "G275 normal harness freezes the measured FAT geometry")
    require(io_error_boot_test, "bytes 5619268 metadata/file/block reads 112/3/113 failures 1 clusters claimed/free/loop/cross/range 10979/5132/0/0/0", "G264 read-EIO harness freezes its private fault-injection geometry")
    require(readonly_remount_boot_test, "bytes 5619268 metadata/file/block reads 111/0/111 failures 0 clusters claimed/free/loop/cross/range 10979/5132/0/0/0", "G264 write-EIO harness freezes its private fault-injection geometry")
    ...
    require(roadmap, "229 complete, 271 open", "roadmap arithmetic includes G275")
    ...
    if len(roadmap_items) != 500 or sum(item == "x" for item in roadmap_items) != 229:
        raise SystemExit("roadmap must contain 500 goals with exactly 229 complete after G275")
