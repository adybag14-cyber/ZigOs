...
def main() -> int:
    ...
    require(readme, "Size:    5,637,632 bytes", "README carries the reproducible G259 ABI 1.20 EFI size")
    require(readme, "SHA-256: BE3BBEC2DCA7C49F5864123D9B602946CB7F4BA74CD7E9E3CBCCAD683ABA8F09", "README carries the reproducible G259 ABI 1.20 EFI hash")
    ...
    require(sdk_shell, "last_status = executeConditionalList(&list, last_status);", "G258/G259 update status only after a fully parsed command or conditional list executes")
    ...
    require(sdk_shell, "fn parseConditionalList(list: *ConditionalList, received: usize) bool", "G259 pre-parses conditional lists before execution")
    ...
    require(roadmap, "213 complete, 287 open", "roadmap arithmetic includes G259")
    ...
    if len(roadmap_items) != 500 or sum(item == "x" for item in roadmap_items) != 213:
        raise SystemExit("roadmap must contain 500 goals with exactly 213 complete after G259")
