...
def main() -> int:
    ...
    require(tty_source, "process.ppid != caller.pid or process.session != caller.session or process.terminal()", "G263 restricts foreground targets to live direct-child leaders in the same session")
