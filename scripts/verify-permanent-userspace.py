...
def main() -> int:
    ...
    require(normal_boot_test, "alloc/free 449/449 cache-released 13 storage persistent clean yes", "normal QEMU gate requires exact G272 physical reclamation and persistent mode")
    ...
    require(io_error_boot_test, "10941/5170/0/0/0 lock tickets/outstanding 4/0 quarantine state/reason/events no/none/0 clean yes", "G272 EIO recovery retains measured private-build FAT ownership")
    ...
    require(readonly_remount_boot_test, "10941/5170/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes", "G272 contained persistent-write profile retains measured private-build FAT ownership")
    ...
    require(runtime_test, "11040/5071/0/0/0 lock tickets/outstanding 5/0 quarantine state/reason/events no/none/0 clean yes", "both G247 diagnostic QEMU profiles require exact global FAT ownership with zero classified corruption")
    ...
    require(normal_boot_test, "10941/5170/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes", "G266 normal QEMU requires exact FAT ownership with zero classified corruption")
    ...
    require(readme, "Size:    5,650,432 bytes", "README carries the reproducible G272 ABI 1.24 EFI size")
    require(readme, "SHA-256: 806F1DED44397F8752601CB8B6669CBF46C69467FBA6F2BC9316C7FE66381AC2", "README carries the reproducible G272 ABI 1.24 EFI hash")
    ...
    require(runtime_test, "bytes 5650500 metadata/file/block reads 112/4/114 failures 0 clusters claimed/free/loop/cross/range 11040/5071/0/0/0", "G247 diagnostic harness freezes the measured FAT geometry")
    require(normal_boot_test, "10941/5170/0/0/0 lock tickets/outstanding 1/0", "G272 normal harness freezes the measured FAT geometry")
    require(io_error_boot_test, "bytes 5599812 metadata/file/block reads 112/3/113 failures 1 clusters claimed/free/loop/cross/range 10941/5170/0/0/0", "G264 read-EIO harness freezes its private fault-injection geometry")
    require(readonly_remount_boot_test, "bytes 5599812 metadata/file/block reads 111/0/111 failures 0 clusters claimed/free/loop/cross/range 10941/5170/0/0/0", "G264 write-EIO harness freezes its private fault-injection geometry")
    ...
    require(roadmap, "226 complete, 274 open", "roadmap arithmetic includes G272")
    ...
    if len(roadmap_items) != 500 or sum(item == "x" for item in roadmap_items) != 226:
        raise SystemExit("roadmap must contain 500 goals with exactly 226 complete after G272")
