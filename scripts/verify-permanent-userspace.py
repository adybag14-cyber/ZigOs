...
def main() -> int:
    ...
    require(roadmap, "207 complete, 293 open", "roadmap arithmetic includes G247")
    ...
    if len(roadmap_items) != 500 or sum(item == "x" for item in roadmap_items) != 207:
        raise SystemExit("roadmap must contain 500 goals with exactly 207 complete after G247")
