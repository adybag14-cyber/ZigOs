...
def main() -> int:
    ...
    require(normal_boot_test, "alloc/free 444/444 cache-released 13 storage persistent clean yes", "normal QEMU gate requires exact G271 physical reclamation and persistent mode")
    ...
    require(io_error_boot_test, "10933/5178/0/0/0 lock tickets/outstanding 4/0 quarantine state/reason/events no/none/0 clean yes", "G264 EIO recovery retains measured private-build FAT ownership")
    ...
    require(readonly_remount_boot_test, "10933/5178/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes", "G264 contained persistent-write profile retains measured private-build FAT ownership")
    require(readonly_remount_boot_test, "alloc/free 62/62 cache-released 11 storage persistent-read-only clean yes", "contained normal boot balances every measured resource")
    ...
    require(runtime_test, "11032/5079/0/0/0 lock tickets/outstanding 5/0 quarantine state/reason/events no/none/0 clean yes", "both G247 diagnostic QEMU profiles require exact global FAT ownership with zero classified corruption")
    ...
    require(normal_boot_test, "10933/5178/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes", "G266 normal QEMU requires exact FAT ownership with zero classified corruption")
    ...
    require(readme, "Size:    5,646,336 bytes", "README carries the reproducible G271 ABI 1.24 EFI size")
    require(readme, "SHA-256: 11EC9AB40EC7B29ABC54F50810B0B23899BBBE43F22C8A921FAF46125027C368", "README carries the reproducible G271 ABI 1.24 EFI hash")
    ...
    require(runtime_test, "bytes 5646404 metadata/file/block reads 112/4/114 failures 0 clusters claimed/free/loop/cross/range 11032/5079/0/0/0", "G247 diagnostic harness freezes the measured FAT geometry")
    require(normal_boot_test, "10933/5178/0/0/0 lock tickets/outstanding 1/0", "G271 normal harness freezes the measured FAT geometry")
    require(io_error_boot_test, "bytes 5595716 metadata/file/block reads 112/3/113 failures 1 clusters claimed/free/loop/cross/range 10933/5178/0/0/0", "G264 read-EIO harness freezes its private fault-injection geometry")
    require(readonly_remount_boot_test, "bytes 5595716 metadata/file/block reads 111/0/111 failures 0 clusters claimed/free/loop/cross/range 10933/5178/0/0/0", "G264 write-EIO harness freezes its private fault-injection geometry")
    ...
    require(roadmap, "225 complete, 275 open", "roadmap arithmetic includes G271")
    ...
    if len(roadmap_items) != 500 or sum(item == "x" for item in roadmap_items) != 225:
        raise SystemExit("roadmap must contain 500 goals with exactly 225 complete after G271")
