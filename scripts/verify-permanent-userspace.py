...
def main() -> int:
    ...
    require(readme, "Size:    5,633,536 bytes", "README carries the reproducible G250 ABI 1.20 EFI size")
    require(readme, "SHA-256: BCF27649C4651DA649EF73E989110AA3D9C9DFD38A1C58318EFE1EE5D95D2ED6", "README carries the reproducible G250 ABI 1.20 EFI hash")
    ...
    require(roadmap, "211 complete, 289 open", "roadmap arithmetic includes G251")
    ...
    if len(roadmap_items) != 500 or sum(item == "x" for item in roadmap_items) != 211:
        raise SystemExit("roadmap must contain 500 goals with exactly 211 complete after G251")
