...
def main() -> int:
    ...
    require(readme, "Size:    5,633,536 bytes", "README carries the reproducible G247 ABI 1.20 EFI size")
    require(readme, "SHA-256: BD9B8A04A157CB64E2C0A4EEBFD67BA73674CCE639FC0BAC0D49BBA206221D5D", "README carries the reproducible G247 ABI 1.20 EFI hash")
    ...
    require(readme, "canonical EFI remains byte-identical to G247", "README records that G248 leaves production runtime bytes unchanged")
    ...
    require(threat_model, "concurrent mutation belongs to G249", "threat model does not overclaim G248 as concurrent stress coverage")
    require(roadmap, "208 complete, 292 open", "roadmap arithmetic includes G248")
    ...
    if len(roadmap_items) != 500 or sum(item == "x" for item in roadmap_items) != 208:
        raise SystemExit("roadmap must contain 500 goals with exactly 208 complete after G248")
