...
def main() -> int:
    ...
    require(normal_boot_test, "10907/5204/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes", "G247 normal QEMU requires exact FAT ownership with zero classified corruption")
    ...
    require(readme, "Size:    5,633,536 bytes", "README carries the reproducible G249 ABI 1.20 EFI size")
    require(readme, "SHA-256: 1843F0EF952E851A09A51F85D69FAA55DF7CE3D4CC76A4CE52D839997CEEB778", "README carries the reproducible G249 ABI 1.20 EFI hash")
    ...
    require(normal_boot_test, "10907/5204/0/0/0 lock tickets/outstanding 1/0", "G247 normal harness freezes the measured FAT geometry")
    ...
    require(roadmap, "209 complete, 291 open", "roadmap arithmetic includes G249")
    ...
    if len(roadmap_items) != 500 or sum(item == "x" for item in roadmap_items) != 209:
        raise SystemExit("roadmap must contain 500 goals with exactly 209 complete after G249")
