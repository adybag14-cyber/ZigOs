        ...
        with stdout_log.open("wb") as stdout_stream, stderr_log.open("wb") as stderr_stream:
            ...
            try:
                ...
                required = (
                    ...
                    "ZigOs boot FAT: block-backed yes files/directories 3/2 bytes 5751876 metadata/file/block reads 112/0/112 failures 0 clusters claimed/free/loop/cross/range 11238/4873/0/0/0 lock tickets/outstanding 1/0 quarantine state/reason/events no/none/0 clean yes",
